...
description: "This essay traces the development of Dover Castle from its early origins through the medieval and early modern periods, focusing on major building campaigns, defensive features, and changing functions. It examines key moments such as the 1216–17 siege, Tudor coastal defense strategy, and later uses including imprisonment and the surviving graffiti left by prisoners of war."
author: Daisy Miloch
date: 2025-12-30
categories: [ built ]
tags: [ Conflict & war, Coast & sea, Buildings & architecture, Heritage & memory, Time periods ]
image: 
...
## **[Dover Castle](Q950970) Throughout the Medieval and Early Modern Periods**
...
{% include embed/image.html src="wc:Dover_Bodenehr_c1730.jpg" aspect="0.685" caption="Plan of Dover, England, engraved by Gabriel Bodenehr, c.1730" %}{: .right}

{% include embed/image.html src="wc:Church-And-Lighthouse-Dover.jpg" aspect="1.333" caption="Church of St. Mary in Castro and the Roman Lighthouse at Dover Castle, Kent" %}{: .right}

{% include embed/map.html center="Q950970" zoom="12" markers="Q950970" allmaps="a691a9303557c733~Davies 1863" %}{: .right}
...
{% include embed/image.html src="wc:Dover-Castle.jpg" aspect="1.333" caption="Dover Castle, Kent" %}{: .right}
...
{% include embed/image.html src="wc:Great-Keep.jpg" aspect="1.333" caption="The Keep at Dover Castle, Kent" %}{: .right}

{% include embed/image.html src="wc:Dover_Castle_Chapel.jpg" aspect="0.75" caption="The chapel within Dover Castle's keep" %}{: .right}
...
{% include embed/image.html src="wc:Colton%27s_Gate_-_Dover_Castle.jpg" aspect="0.75" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/5ebdc42a-63b3-4862-8985-5b04bec60889" aspect="0.667" caption="The Stone Hall West Window at the Maison Dieu, Dover, depicting Hubert de Burgh, designed and made by William Wailes of Newcastle upon Tyne and installed in 1858" attribution="Copyright Maison Dieu/Dover District Council" %}{: .right}
...
{% include embed/image.html src="wc:Plan_of_Dover_and_of_Dover_Castle_and_Archclift_Fort_%281756%29.jpg" aspect="1.911" caption="The BL King’s Topographical Collection, Plan of Dover and of Dover Castle and Archclift Fort with the new rampart, covertway, batterys and barracks erect'd in 1756" %}{: .right}
...
{% include embed/image.html src="wc:Graffiti-Dover-Ship.jpg" aspect="1.334" caption="Historic Graffiti of a ship at Dover Castle, Kent" %}{: .right}

{% include embed/image.html src="wc:Graffiti-Dover.jpg" aspect="1.333" caption="Historic Graffiti at Dover Castle, Kent" %}{: .right}

{% include embed/image.html src="wc:Graffiti-Dover1.jpg" aspect="1.333" caption="Historic Graffiti at Dover Castle, Kent" %}{: .right}

{% include embed/image.html src="wc:Graffiti-Dover2.jpg" aspect="0.762" caption="Historic Graffiti at Dover Castle, Kent" %}{: .right}
