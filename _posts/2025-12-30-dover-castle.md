...
description: "This essay traces Dover Castle’s development from its early origins through the medieval and early modern periods, focusing on major building phases under Norman and Plantagenet kings and later Tudor adaptations. It highlights the castle’s strategic coastal role in siege warfare and defense, and uses surviving fabric such as the keep, curtain walls, tunnels, and historic graffiti to interpret changing functions over time."
author: Daisy Miloch
date: 2025-12-30
categories: [ built ]
...
{% include embed/image.html src="wc:Dover_Bodenehr_c1730.jpg" aspect="0.685" caption="Plan of Dover, England, engraved by Gabriel Bodenehr, c.1730" %}

{% include embed/image.html src="wc:Church-And-Lighthouse-Dover.jpg" aspect="1.333" caption="Church of St. Mary in Castro and the Roman Lighthouse at Dover Castle, Kent" %}

{% include embed/map.html center="Q950970" zoom="12" markers="Q950970" allmaps="a691a9303557c733~Davies 1863" %}
...
{% include embed/image.html src="wc:Dover-Castle.jpg" aspect="1.333" caption="Dover Castle, Kent" %}
...
{% include embed/image.html src="wc:Great-Keep.jpg" aspect="1.333" caption="The Keep at Dover Castle, Kent" %}

{% include embed/image.html src="wc:Dover_Castle_Chapel.jpg" aspect="0.75" caption="The chapel within Dover Castle's keep" %}
...
{% include embed/image.html src="wc:Colton%27s_Gate_-_Dover_Castle.jpg" aspect="0.75" %}
...
{% include embed/image.html src="wc:Plan_of_Dover_and_of_Dover_Castle_and_Archclift_Fort_%281756%29.jpg" aspect="1.911" caption="The BL King’s Topographical Collection, Plan of Dover and of Dover Castle and Archclift Fort with the new rampart, covertway, batterys and barracks erect'd in 1756" %}
...
{% include embed/image.html src="wc:Graffiti-Dover-Ship.jpg" aspect="1.334" caption="Historic Graffiti of a ship at Dover Castle, Kent" %}

{% include embed/image.html src="wc:Graffiti-Dover.jpg" aspect="1.333" caption="Historic Graffiti at Dover Castle, Kent" %}

{% include embed/image.html src="wc:Graffiti-Dover1.jpg" aspect="1.333" caption="Historic Graffiti at Dover Castle, Kent" %}

{% include embed/image.html src="wc:Graffiti-Dover2.jpg" aspect="0.762" caption="Historic Graffiti at Dover Castle, Kent" %}
