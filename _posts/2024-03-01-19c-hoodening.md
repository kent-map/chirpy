...
{% include embed/image.html src="wc:Hooden_Horses_at_the_Clock_Tower_%28geograph_5502334%29.jpg" aspect="0.759" caption="Hooden Horses at the Clock Tower, Broadstairs" %}{: .right}

{% include embed/image.html src="wc:Broadstairs_Folk_Week_2018_FDBY6092_%2843372181465%29.jpg" aspect="1.502" %}{: .right}

<!--Basemap centred on Elmstone Church to show NE Kent coastline-->

{% include embed/map.html center="Q17557672" zoom="11" markers="Q17557672" allmaps="08f8a4bca9b4dd3a~Kent OS 1860" %}{: .right}
...
{% include embed/image.html src="images/Hoodenhorse.jpg" aspect="1.0" caption="Hooden Horse" attribution="©Carolyn Oulton" %}{: .right}

<!--Basemap centred on Nash Court -->

{% include embed/map.html center="Q26386990" zoom="12" markers="Q26386990" allmaps="08f8a4bca9b4dd3a~Kent OS 1860" %}{: .right}
...
{% include embed/image.html src="wc:Deal_Hoodeners%2C_1909.jpg" aspect="1.0" caption="Hoodener in Deal" %}{: .right}
...
{% include embed/image.html src="wc:Hoodening_in_Whitstable_May_2018.jpg" aspect="0.686" caption="Hoodening in Whitstable" %}{: .right}
...
{% include embed/image.html src="images/hoodeners.jpg" aspect="1.0" caption="Hoodeners from Hale Farm in St. Nicholas-at-Wade, Kent, as photographed in June 1905" attribution="This Photo by Unknown Author is licensed under CC BY-SA. Hoodeners are still active in these villages today" %}{: .right}
...
{% include embed/image.html src="wc:Odin_rides_to_Hel.jpg" aspect="1.535" caption="Odin rides to Hel" %}{: .right}
...
{% include embed/image.html src="wc:Walmer_hoodeners%2C_1907.jpg" aspect="1.0" caption="A troupe of hoodeners from Walmer Court Farm in Walmer, Kent" %}{: .right}
