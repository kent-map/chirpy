---
title: "River Dour"
description: "This essay traces the River Dour from its chalk-stream source at Watersend through Dover’s parks, mills, culverts, and harbour, showing how the river has been reshaped by urban growth and industry. Using local reports, historical writing, and place-based snapshots, it highlights shifting attitudes to pollution, flooding, wildlife habitat, and civic responsibility along the river’s short course."
author: Michelle Crowther
date: 2025-06-05
categories: [ landscape ]
tags: [ Rivers & marshes, Towns & cities, Nature & environment, Work & industry, Heritage & memory ]
image: 
  path: "https://stor.artstor.org/stor/b4fb174f-5884-4bfc-832a-20fc4b3683dc"
layout: post
...
In 1900, the novelist, poet and critic, [Ford Madox Ford]({{ site.baseurl }}/20c/20c-fordmadoxford-biography/) in _The Cinque Ports: A Historical and Descriptive Record_ dismissed the River Dour as unworthy of note:

In among the houses one sees at times the poor little river Dour, a pathetic thread of silver that seems to have no real purpose in days like these. One thinks that its whole short course ought to be covered up and itself made to run through culverts. The principal part of its stream is supplied by a nailbourne, and when this chooses to run the Dour boasts a certain head of water. As a rule, it dribbles dispiritedly from [Ewell](Q2703021) to the sea, a distance of a few miles.[^ref1] 
...
{% include embed/map.html center="Q7337355" zoom="12" markers="Q7337355" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}
...
The saying is often repeated in newspapers and topographical books, and presumably indicates that wheat prices will rise due to scarcity of the crop. In an alternative version, the wheat is only valued at 1 shilling "and bullocks at a crown".[^ref7] In his _General View of the Agriculture of the County of Kent_ [John Boys]({{ site.baseurl }}/18c/18c-boys-biography/) had observed that chalky soils when improved were very good for "turnips, barley, clover and wheat".[^ref8]

{% include embed/map.html center="Q2703021" zoom="15" markers="Q2703021" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}
...
{% include embed/map.html center="Q26318758" zoom="15" markers="Q26318758" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}
...
{% include embed/image.html src="wc:Russell_Gardens_-_geograph.org.uk_-_5259889.jpg" aspect="1.511" caption="Russell Gardens" %}{: .right}

**[Kearsney Abbey](Q26431966)**    
...
{% include embed/image.html src="wc:Kearnsney_abbey_Dover.jpg" aspect="1.562" caption="Kearnsey Abbey" %}{: .right}
...
{% include embed/image.html src="wc:Crabble_Corn_Mill_-_geograph.org.uk_-_4255589.jpg" aspect="1.333" caption="Crabble Corn Mill" %}{: .right}
...
{% include embed/image.html src="wc:Alterations_to_Buckland_Paper_Mill%2C_Crabble_Hill_-_geograph.org.uk_-_5429402.jpg" aspect="1.333" caption="Alterations to Buckland Paper Mill, Crabble Hill, 2017" %}{: .right}
...
{% include embed/image.html src="wc:River_Dour%2C_Dover_-_geograph.org.uk_-_4674922.jpg" aspect="1.333" caption="River Dour" %}{: .right}
...
{% include embed/image.html src="wc:River_Dour%2C_Dover_-_geograph.org.uk_-_2263909.jpg" aspect="1.385" caption="River Dour" %}{: .right}
...
{% include embed/image.html src="wc:Dover%2C_River_Dour_-_geograph.org.uk_-_2868890.jpg" aspect="1.333" caption="Dover, River Dour" %}{: .right}
...
{% include embed/image.html src="wc:Dover%2C_River_Dour_-_geograph.org.uk_-_2869094.jpg" aspect="1.333" caption="Dover, River Dour" %}{: .right}
...
{% include embed/image.html src="wc:The_Lord_Nelson_-_geograph.org.uk_-_6396916.jpg" aspect="1.333" caption="The Lord Nelson" %}{: .right}
...
{% include embed/image.html src="wc:Wellington_Dock_-_geograph.org.uk_-_4588572.jpg" aspect="1.334" caption="Wellington Dock" %}{: .right}
