...
description: "This essay traces Ian Fleming’s deep personal ties to Kent and shows how places he lived in and visited, from St Margaret’s Bay to Sandwich and Canterbury, fed directly into the James Bond novels. It reads Moonraker and Goldfinger as literary reimaginings of the Kent coast and countryside, linking Fleming’s biography to the landscapes and scenes he wrote."
author: Fred Marsh
date: 2024-03-01
categories: [ 20c ]
...
layout: post
permalink: /20c/fleming-biography/
published: true
toc: false    
---
...
![Royal St George's Golf Clubhouse](https://upload.wikimedia.org/wikipedia/commons/7/7c/Royal_St_George%27s_Golf_Clubhouse._-_geograph.org.uk_-_304182.jpg)
_Royal St George's Golf Clubhouse_
{: .right}

<!-- Basemap centred on Sandwich -->

{% include embed/map.html center="Q26163" zoom="12" marker="true" %}{: .right}
...
![White cliffs at St. Margaret's Bay](https://upload.wikimedia.org/wikipedia/commons/1/15/White_cliffs_at_St._Margaret%27s_Bay_-_geograph.org.uk_-_2139591.jpg)
_White cliffs at St. Margaret's Bay_
{: .right}
<!-- Basemap centred on Lydden -->

{% include embed/map.html center="Q2624651" zoom="11.25" marker="true" %}{: .right}

{% include embed/map.html center="Q24638363" zoom="12" marker="true" %}{: .right}

{% include embed/map.html center="Q4881598" zoom="12" marker="true" %}{: .right}

{% include embed/map.html center="Q3370771" zoom="12" marker="true" %}{: .right}
...
![Portrait Bench, Dover seafront](https://stor.artstor.org/stor/07405b1d-ef21-4501-90ed-3ad985c20029)
_Portrait Bench, Dover seafront_
{: .right}
...
![St Margaret's Bay](https://upload.wikimedia.org/wikipedia/commons/7/73/St_Margaret%27s_Bay_-_geograph.org.uk_-_2153408.jpg)
_St Margaret's Bay_
{: .right}
<!-- Basemap centred on Waldershare -->

{% include embed/map.html center="Q7961502" zoom="11.5" marker="true" %}{: .right}
...
![The White Cliffs of Dover](https://upload.wikimedia.org/wikipedia/commons/e/ea/The_White_Cliffs_of_Dover_%2848904125611%29.jpg)
_The White Cliffs of Dover_
{: .right}
<!-- Basemap centred on Bekesbourne -->

{% include embed/map.html center="Q4881598" zoom="10.75" marker="true" %}{: .right}

{% include embed/map.html center="Q3370771" zoom="12" marker="true" %}{: .right}

{% include embed/map.html center="Q618045" zoom="12" marker="true" %}{: .right}
...
![St Margaret's Bay Beach](https://upload.wikimedia.org/wikipedia/commons/8/86/Dog_On_St._Margaret%27s_Bay_Beach.jpg)
_St Margaret's Bay Beach_
{: .right}
<!-- Basemap centred on Waldershare -->
...
![Looking along Undercliffe Road, Kingsdown](https://upload.wikimedia.org/wikipedia/commons/7/74/Looking_S_along_Undercliffe_Road%2C_Kingsdown_-_geograph.org.uk_-_485185.jpg)
_Looking along Undercliffe Road, Kingsdown_
{: .right}
...
![Reculver from the air](https://upload.wikimedia.org/wikipedia/commons/e/e4/Reculver_from_the_air.jpg)
_Reculver from the air_
{: .right}
...
![Quince Orchard at Brogdale, Faversham](https://upload.wikimedia.org/wikipedia/commons/0/0e/Quince_Orchard%2C_Brogdale_-_geograph.org.uk_-_418906.jpg)
_Quince Orchard at Brogdale, Faversham_
{: .right}
<!-- Basemap centred on Wickhambreaux -->

{% include embed/map.html center="Q3092462" zoom="11" marker="true" %}{: .right}

{% include embed/map.html center="Q618045" zoom="12" marker="true" %}{: .right}

{% include embed/map.html center="Q929286" zoom="12" marker="true" %}{: .right}

{% include embed/map.html center="Q865021" zoom="12" marker="true" %}{: .right}

{% include embed/map.html center="Q964785" zoom="12" marker="true" %}{: .right}
...
![Blue Plaque at the Duck, Pett Bottom](https://stor.artstor.org/stor/eccb379a-a975-40fc-a14c-f6f34a0163de)
_Blue Plaque at the Duck, Pett Bottom_
{: .right}
...
![Higham Park, Bridge, Kent, home of Count Zborowski, whose car collection inspired Fleming to write Chitty Chitty Bang Bang](https://upload.wikimedia.org/wikipedia/commons/5/54/Higham_Park%2C_Bridge%2C_Kent_-_geograph.org.uk_-_123345.jpg)
_Higham Park, Bridge, Kent, home of Count Zborowski, whose car collection inspired Fleming to write Chitty Chitty Bang Bang_
{: .right}
