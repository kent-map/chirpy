...
layout: post
permalink: /19c/atkins-biography/
published: true
toc: false    
---
...
![Anna Atkins, 1861](https://upload.wikimedia.org/wikipedia/commons/4/48/Anna_Atkins_1861.jpg)
_Anna Atkins, 1861_
{: .right}

{% include embed/map.html center="Q2048526" zoom="11" marker="true" %}{: .right}

{% include embed/map.html center="Q936183" zoom="13" marker="true" %}{: .right}

{% include embed/map.html center="Q99678204" zoom="13" marker="true" %}{: .right}

{% include embed/map.html center="Q2220232" zoom="13" marker="true" %}{: .right}

{% include embed/map.html center="Q2048526" zoom="13" marker="true" %}{: .right}
...
![John George Children](https://upload.wikimedia.org/wikipedia/commons/d/df/John_George_Children.jpg)
_John George Children_
{: .right}

{% include embed/map.html center="Q26645227" zoom="13" marker="true" %}{: .right}
...
![Humphry Davy, 1803](https://upload.wikimedia.org/wikipedia/commons/2/2c/Davy_Humphry_desk_color_Howard.jpg)
_Humphry Davy, 1803_
{: .right}

{% include embed/map.html center="Q26645227" zoom="13" marker="true" %}{: .right}

{% include embed/map.html center="Q17545758" zoom="13" marker="true" %}{: .right}
...
![Waterloo Elm by Anna Children](https://upload.wikimedia.org/wikipedia/commons/3/39/Waterloo_Elm_by_Anna_Children.jpg)
_Waterloo Elm by Anna Children_
{: .right}

{% include embed/map.html center="Q99678204" zoom="11" marker="true" %}{: .right}

{% include embed/map.html center="Q2050835" zoom="13" marker="true" %}{: .right}

{% include embed/map.html center="Q122384" zoom="13" marker="true" %}{: .right}
...
![Cyanotypes of British Algae](https://upload.wikimedia.org/wikipedia/commons/f/fe/Digital_ID-_419707._Atkins%2C_Anna_-_Photographer._1843-53_%283110003250%29.jpg)
_Cyanotypes of British Algae_
{: .right}
...
![Anna Atkins](https://upload.wikimedia.org/wikipedia/commons/f/f0/Anna_Atkins_-_New_Zealand_-_Google_Art_Project.jpg)
_Anna Atkins_
{: .right}
...
![St Margaret's Church, Halstead](https://upload.wikimedia.org/wikipedia/commons/1/17/St_Margaret%27s_Church%2C_Halstead.JPG)
_St Margaret's Church, Halstead_
{: .right}

{% include embed/map.html center="Q2426311" zoom="11" marker="true" %}{: .right}

{% include embed/map.html center="Q99678204" zoom="13" marker="true" %}{: .right}

{% include embed/map.html center="Q939838" zoom="13" marker="true" %}{: .right}

{% include embed/map.html center="Q2744669" zoom="13" marker="true" %}{: .right}
