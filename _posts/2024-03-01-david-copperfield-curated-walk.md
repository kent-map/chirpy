...
{% include embed/image.html src="https://stor.artstor.org/stor/360206a8-3604-42df-806f-0059dbbf2b85" aspect="1.499" caption="The Micawbers at Canterbury" %}{: .right}

<!-- Base map default centred on Boughton --> 

{% include embed/map.html center="Q4949442" zoom="10" markers="Q4949442" allmaps="~Dover Road" %}{: .right}

On his arrival in [Dover]({{ site.baseurl }}/dickens/dickens-dover) on the sixth day of his journey, David is immediately reminded of the obstacles that his unkempt condition has placed between himself and the sanctuary he is trying to attain. His appearance is not prepossessing and he struggles to be taken seriously by the townspeople:
...
{% include embed/map.html center="Q179224" zoom="12.5" markers="Q179224" allmaps="~Dover Road" %}{: .right}
...
{% include embed/image.html src="wc:Canterbury_-_The_Buttermarket_-_geograph.org.uk_-_6444523.jpg" aspect="1.5" caption="Canterbury - The Buttermarket" %}{: .right}

At this point David is assimilated into the Kent landscape, moving between [Dover]({{ site.baseurl }}/dickens/dickens-dover) and [Canterbury,]({{ site.baseurl }}/dickens/david-copperfield-canterbury) where he is put to school with Dr Strong and develops romantic attachments to a succession of young woman like the eldest Miss Larkins.

{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/images/main/dickens/The_Eldest_Miss_Larkins_T00072-21.jpg" aspect="0.694" caption="The Eldest Miss Larkins" %}{: .right}
...
[Canterbury]({{ site.baseurl }}/dickens/david-copperfield-canterbury) to visit Agnes Wickfield, for whose sake he will triumphantly denounce Uriah Heep with the aid of Traddles and Mr Micawber. 

{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/images/main/dickens/Heep_of_Infamy_M00002-10.jpg" aspect="1.361" %}{: .right}

{% include embed/map.html center="Q29303" zoom="13" markers="Q29303" allmaps="~Dover Road" %}{: .right}

Towards the end of the novel the Micawbers will anticipate Pip’s journey downriver to [Gravesend]({{ site.baseurl }}/19c/19c-gravesend). The night before Mr Micawber is inevitably arrested for debt and has to be baled out by David. But unlike Magwitch he is able to leave openly on the steamer from Hungerford Steps on his way to make his fortune in Australia.
<!-- Map centred on Gravesend -->

{% include embed/map.html center="Q676689" zoom="13" markers="Q676689" allmaps="~Dover Road" %}{: .right}

Only once, in a desperate bid to avoid a tête á tête with Uriah, does David strike out in a new direction on the [Ramsgate]({{ site.baseurl }}/19c/19c-ramsgate) road. His failure to reference Thanet seems peculiar given its accessibility from [Canterbury]({{ site.baseurl }}/dickens/david-copperfield-canterbury) and [Dickens]({{ site.baseurl }}/dickens/dickens-biography)’s own love of the sea – indeed parts of the novel were written in [Fort House](dickens-fort-house) in [Broadstairs]({{ site.baseurl }}/dickens/broadstairs). But beyond the pages of the novel itself David is keeping another secret – while his donkey-loathing aunt ostensibly lives in [Dover]({{ site.baseurl }}/dickens/dickens-dover), the inspiration for her cottage is to be found in [2 Nuckell’s Place]({{ site.baseurl }}/dickens/david-copperfield-nuckells-place) (now the [Dickens House Museum](https://www.visitkent.co.uk/attractions/dickens-house-museum-1999/)) in 
[Broadstairs]({{ site.baseurl }}/dickens/broadstairs). If David ultimately succeeds in working out where home is, this is not a secret he is prepared to share with the reader.
<!-- Map centred on Nash, NE Kent -->

{% include embed/map.html center="Q26386990" zoom="12" markers="Q26386990" allmaps="~Dover Road" %}{: .right}
