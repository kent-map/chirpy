...
description: "This essay traces the growth of higher education in late-20th-century Canterbury through the development of the University of Kent, Canterbury Christ Church University, and the University for the Creative Arts. It connects institutional expansion to campus architecture, student accommodation, and the changing use of historic urban sites around the city."
...
{% include embed/map.html center="Q1516684" zoom="15" markers="Q1516684" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}{: .right}

#### [The University of Kent](Q1516684)

The University of Kent at Canterbury opened its doors in 1965. Situated on the high ground between St Thomas’ and Tyler hills to the north of Canterbury within 300 acres of parkland the campus affords stunning views of the old city Canterbury and Cathedral. Designed to be a collegiate university with most students living in colleges with resident tutors, the four original colleges, Darwin, Eliot (named after the poet [T. S. Eliot]({{ site.baseurl }}/20c/20c-eliot-biography), who died on the same day that UKC was established, 24 January 1965), Keynes and Rutherford, were followed by three more colleges in the first decade. 

{% include embed/image.html src="wc:School_of_Arts_-_UKC.JPG" aspect="1.333" caption="University of Kent School of Arts" %}{: .right}
...
{% include embed/image.html src="wc:Keynes_Centenary_Seminar_1983.jpg" aspect="1.911" caption="Keynes Centenary Seminar, University of Kent, 1983" %}{: .right}

{% include embed/image.html src="wc:Keynes_College%2C_Kent_University.jpg" aspect="1.0" caption="Keynes College, University of Kent" %}{: .right}
...
{% include embed/image.html src="wc:Darwin_College_-_UKC.JPG" aspect="1.333" caption="Darwin College, University of Kent" %}{: .right}

{% include embed/image.html src="wc:Parkwood_-_UKC.JPG" aspect="1.333" caption="Parkwood, University of Kent" %}{: .right}

While this construction was going on apace the Cornwallis building was unwittingly built over the tunnel of the historic [Canterbury and Whitstable Railway](Q5033707). At the cutting edge of technology in 1826 the half mile tunnel under the high ground at Tyler Hill had provided a direct route for the world’s first steam passenger railway. On the evening of 11 July 1974 the south-west part of the building sank into the ground when the tunnel beneath collapsed. The university had to demolish the sunken part which was rebuilt as another wing. The old tunnel was blocked up with concrete. It was noticeable in the 1990s that parts of the building were still uneven and that within the building some corridors went nowhere.
...
{% include embed/image.html src="wc:Turing_College.jpg" aspect="1.778" caption="Turing College, University of Kent" %}{: .right}

{% include embed/image.html src="wc:Campus_shops_-_UKC.JPG" aspect="1.333" caption="Campus shops, University of Kent" %}{: .right}

#### [Canterbury Christ Church University](Q3182956)
...
{% include embed/image.html src="https://stor.artstor.org/stor/ada7827f-a5e3-4daa-a6d2-8bf65efd1113" aspect="1.59" caption="1960s campus at CCCU" attribution="© Canterbury Christ Church University, used with kind permission" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/fa0a8eed-c703-49da-8fc5-ab5e9f9b58f2" aspect="1.51" caption="History class in the early 1980s" attribution="© Canterbury Christ Church University, used with kind permission" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/9e1ce94c-02c1-4e20-841d-2a5996d2e8d2" aspect="1.778" caption="Drone view of prison backlands and site for Building 2 at CCCU" attribution="© DDS Demolition, 2018, used with kind permission" %}{: .right}

{% include embed/image.html src="https://stor.artstor.org/stor/86d7445f-2196-48b6-a135-182c7865c7a3" aspect="1.501" caption="View across the Quad to Hepworth at CCCU" attribution="© Canterbury Christ Church University, used with kind permission" %}{: .right}
...
{% include embed/image.html src="wc:Pride_in_London_2016_-_Canterbury_Christ_Church_University_participating_in_the_parade.png" aspect="1.5" caption="CCCU staff and students participating in Pride in London, 2016" %}{: .right}

#### University for the Creative Arts

The University for the Creative Arts at Canterbury, which today counts 6,000 students, combines the former Canterbury School of Art (founded 1882) and School of Architecture (founded 1948). The UCA is located on part of the former Barton Manor Estate, farm land which as the medieval ‘borough” of Longport had pertained to St Augustine’s Abbey. Accessed from the [Old Dover Road]({{ site.baseurl }}/dickens/david-copperfield-dover-road) the site is divided between UCA and Canterbury Technology College (established 1947).

{% include embed/image.html src="wc:University_for_the_Creative_Arts_2015_logo.svg.png" aspect="1.57" caption="UCA logo" %}{: .right}

The Canterbury School of Art, founded in 1868 by the landscape and animal painter, Thomas Sidney Cooper, came into formal existence in 1882 when Sidney Cooper presented his home in St Peter’s Street  to the City of Canterbury. One of Cooper’s students in the 1890’s Mary Tourtel (1874-1948) became the creator of [Rupert the Bear]({{ site.baseurl }}/20c/20c-tourtel-biography), as a cartoon strip first published in the Daily Express in 1920. Four studios were added by the city council in 1911.  By 1937 the Art School counted 137 pupils. After the Second World War the School gained an annex in St Peter’s lane. It remained housed in the building that had been Sidney Cooper’s home and studio until 1972.

{% include embed/image.html src="wc:Thomas_Sidney_Cooper%2C_by_Thomas_Sidney_Cooper.jpg" aspect="0.753" caption="Self-portrait, Thomas Sidney Cooper, c.1832" %}{: .right}
...
{% include embed/image.html src="wc:Sidney_Cooper_gallery.JPG" aspect="0.577" caption="Sidney Cooper gallery" %}{: .right}
