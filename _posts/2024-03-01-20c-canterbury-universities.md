...
description: "This essay charts the growth of higher and further education in Canterbury across the late 20th century, focusing on the University of Kent, Canterbury Christ Church University, and the University for the Creative Arts. It links institutional expansion to campus planning, building programmes, and the universities’ changing roles within the city and wider county."
...
{% include embed/image.html src="wc:School_of_Arts_-_UKC.JPG" aspect="1.333" caption="University of Kent School of Arts" %}
...
{% include embed/image.html src="wc:Keynes_Centenary_Seminar_1983.jpg" aspect="1.911" caption="Keynes Centenary Seminar, University of Kent, 1983" %}

{% include embed/image.html src="wc:Keynes_College%2C_Kent_University.jpg" aspect="1.0" caption="Keynes College, University of Kent" %}
...
{% include embed/image.html src="wc:Darwin_College_-_UKC.JPG" aspect="1.333" caption="Darwin College, University of Kent" %}

{% include embed/image.html src="wc:Parkwood_-_UKC.JPG" aspect="1.333" caption="Parkwood, University of Kent" %}
...
{% include embed/image.html src="wc:Turing_College.jpg" aspect="1.778" caption="Turing College, University of Kent" %}

{% include embed/image.html src="wc:Campus_shops_-_UKC.JPG" aspect="1.333" caption="Campus shops, University of Kent" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/ada7827f-a5e3-4daa-a6d2-8bf65efd1113" aspect="1.59" caption="1960s campus at CCCU" attribution="© Canterbury Christ Church University, used with kind permission" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/fa0a8eed-c703-49da-8fc5-ab5e9f9b58f2" aspect="1.51" caption="History class in the early 1980s" attribution="© Canterbury Christ Church University, used with kind permission" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/9e1ce94c-02c1-4e20-841d-2a5996d2e8d2" aspect="1.778" caption="Drone view of prison backlands and site for Building 2 at CCCU" attribution="© DDS Demolition, 2018, used with kind permission" %}

{% include embed/image.html src="https://stor.artstor.org/stor/86d7445f-2196-48b6-a135-182c7865c7a3" aspect="1.501" caption="View across the Quad to Hepworth at CCCU" attribution="© Canterbury Christ Church University, used with kind permission" %}
...
{% include embed/image.html src="wc:Pride_in_London_2016_-_Canterbury_Christ_Church_University_participating_in_the_parade.png" aspect="1.5" caption="CCCU staff and students participating in Pride in London, 2016" %}
...
{% include embed/image.html src="wc:University_for_the_Creative_Arts_2015_logo.svg.png" aspect="1.57" caption="UCA logo" %}
...
{% include embed/image.html src="wc:Thomas_Sidney_Cooper%2C_by_Thomas_Sidney_Cooper.jpg" aspect="0.753" caption="Self-portrait, Thomas Sidney Cooper, c.1832" %}
...
{% include embed/image.html src="wc:Sidney_Cooper_gallery.JPG" aspect="0.577" caption="Sidney Cooper gallery" %}
