...
date: 2024-03-01
categories: [ 20c ]
tags: [ Texts & genres, Countryside & farming, Culture & society, Maps & place-making ]
image: 
  path: "https://upload.wikimedia.org/wikipedia/commons/4/44/Hopping_in_Kent-_Hop-picking_in_Yalding%2C_Kent%2C_England%2C_UK%2C_1944_D22170.jpg"
layout: post
...
{% include embed/image.html src="wc:Hop-Picking_in_Kent_by_Stephen_Thompson_1875.jpg" aspect="1.213" caption="Hop-Picking in Kent by Stephen Thompson 1875" %}{: .right}
...
{% include embed/map.html center="Q2460124" zoom="9.25" markers="Q2460124" allmaps="d549f0ddbeca485f~OS Kent 1899" %}{: .right}
...
{% include embed/image.html src="wc:Hopping_in_Kent-_Hop-picking_in_Yalding%2C_Kent%2C_England%2C_UK%2C_1944_D22172.jpg" aspect="1.322" caption="Hopping in Kent- Hop-picking in Yalding, Kent, England, UK, 1944" %}{: .right}

With a characteristic splicing of verve and sharp observation, [Dickens]({{ site.baseurl }}/dickens/dickens-biography) wrote in [_The Uncommercial Traveller_]( https://www.djo.org.uk/indexes/authors/charles-dickens/the-uncommercial-traveller.html) about the prevalence of casual labour in the countryside surrounding his home at [Gad’s Hill]({{ site.baseurl }}/dickens/dickens-gads-hill):
...
{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/images/main/20c/Oast_houses_MJC.jpg" aspect="1.889" caption="The Hop Farm" attribution="© Martin Crowther" %}{: .right}

{% include embed/image.html src="wc:The_Uncommercial_Traveller_Illus_1.jpg" aspect="1.552" caption="The Uncommercial Traveller, Charles Dickens" %}{: .right}

{% include embed/map.html center="Q104082075" zoom="12.75" markers="Q104082075" allmaps="d549f0ddbeca485f~OS Kent 1899" %}{: .right}
...
{% include embed/image.html src="wc:Portrait_Sketch_of_Joseph_Pennell.jpg" aspect="0.656" caption="Portrait Sketch of Joseph Pennell" %}{: .right}

{% include embed/image.html src="wc:Hopping_in_Kent-_Hop-picking_in_Yalding%2C_Kent%2C_England%2C_UK%2C_1944_D22170.jpg" aspect="1.325" caption="Hopping in Kent- Hop-picking in Yalding, Kent, England, UK, 1944" %}{: .right}

{% include embed/map.html center="Q29303" zoom="12.75" markers="Q29303" allmaps="d549f0ddbeca485f~OS Kent 1899" %}{: .right}

The presence of Londoners – or perhaps strangers in general -continued to be a source of tension in the early years of the twentieth century, as local author [Bessie Marchant]({{ site.baseurl }}/19c/19c-marchantb-biography)’s 1904 _Yew Tree Farm_ makes clear. The story of three sisters who take up farming on their own account, the book is largely preoccupied crop and sheep management as well as the mechanics of negotiating prices at market. Hop picking appears only briefly, but tellingly the narrator the flags up a decided tension between local workers and those from further afield:
...
{% include embed/image.html src="wc:Hopping_in_Kent-_Hop-picking_in_Yalding%2C_Kent%2C_England%2C_UK%2C_1944_D22167.jpg" aspect="1.006" caption="Hopping in Kent- Hop-picking in Yalding, Kent, England, UK, 1944" %}{: .right}

But later fictional accounts repeatedly invoke the language of nostalgia, a rhetorical move that allows the contemporary worker to disappear into an imagined tradition. In a novel published in 1916, it is understandable that Eden Phillpotts should create an idealised rural community in the Weald, in which ‘Broad and beamy matrons, slim girls, grey-beards, grandmothers and bright-eyed children clustered together with smiles and cheerful looks. All wore a brave, morning face, and preserved that immemorial holiday aspect proper to the picking.’ A year earlier even the sceptical [Somerset Maugham]({{ site.baseurl }}/20c/20c-maugham-biography) had assured readers that for the East Kent hop pickers coming from villages such as Ferne near Folkestone (going presumably to [Canterbury](Q29303)) ‘The work was not hard, it was done in common, in the open air, and for the children it was a long, delightful picnic; here the young men met the maidens; in the long evenings when work was over they wandered about the lanes, making love; and the hopping season was generally followed by weddings.’ The picking season provides an idyllic interlude for Philip Carey, originally from Whitstable, who returns from London for a working holiday.

{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/images/main/20c/Hop_pickers.jpg" aspect="1.834" caption="Hop Picking by T.C. Dugdale, 1937" attribution="© Martin Crowther" %}{: .right}

{% include embed/image.html src="wc:Hopping_in_Kent-_Hop-picking_in_Yalding%2C_Kent%2C_England%2C_UK%2C_1944_D22175.jpg" aspect="1.325" caption="Hopping in Kent- Hop-picking in Yalding, Kent, England, UK, 1944" %}{: .right}

{% include embed/map.html center="Q632173" zoom="10" markers="Q632173" allmaps="d549f0ddbeca485f~OS Kent 1899" %}{: .right}

{% include embed/map.html center="Q375314" zoom="13" markers="Q375314" allmaps="d549f0ddbeca485f~OS Kent 1899" %}{: .right}

{% include embed/map.html center="Q964785" zoom="13" markers="Q964785" allmaps="d549f0ddbeca485f~OS Kent 1899" %}{: .right}
...
{% include embed/map.html center="Q7519165" zoom="12.75" markers="Q7519165" allmaps="d549f0ddbeca485f~OS Kent 1899" %}{: .right}
...
Winstanley, Michael. _Life in Kent at the Turn of the Century_. [Folkestone](Q375314): Wm Dawson and Son, 1978.