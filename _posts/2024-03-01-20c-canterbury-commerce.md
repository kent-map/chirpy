...
description: "This essay traces how Canterbury’s economy in the 20th century remained rooted in rural markets while a few family firms expanded with new technologies and changing consumer demand. It follows the growth of ParkerSteel and Barretts across shifting sites in the city, set against wartime disruption, postwar prosperity, and later planning and redevelopment."
author: Richard Maltby
date: 2024-03-01
categories: [ canterbury ]
tags: [ Work & industry, Towns & cities, Travel & mobility, Heritage & memory ]
image: 
...
{% include embed/image.html src="https://stor.artstor.org/stor/5129a00d-b3c8-46f1-b40c-fe241d7d0479" aspect="1.57" caption="Cattle market at Canterbury around 1900" attribution="Public domain, photo from Léon et Lévy" %}

{% include embed/image.html src="https://stor.artstor.org/stor/03bbed1c-285e-4f1b-b03f-6169a6afca1c" aspect="1.5" caption="Market area today" attribution="Connor Treston, by kind permission" %}

{% include embed/map.html center="Q26535561" zoom="15" markers="Q26535561" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}
...
{% include embed/map.html center="Q1434239" zoom="15" markers="Q1434239" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/d0564753-7dc5-4985-8e3f-2fbcab4ee5d6" aspect="1.566" caption="St Peter's Street, pre-1918" attribution="Postcard, Léon & Levy" %}
...
{% include embed/map.html center="Q26551393" zoom="15" markers="Q26551393" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/5dd13fa2-03ce-46d5-bd42-34901758643d" aspect="1.333" caption="Wincheap Industrial Estate" attribution="Edward Crowther, by kind permission" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/cd790d83-8b41-4b53-a497-4d691528174f" aspect="1.437" caption="Fire at Barrett's on St Peter's Street, 1937" attribution="Photographer unknown" %}

{% include embed/image.html src="wc:Bundesarchiv_Bild_101I-662-6659-37%2C_Flugzeug_Messerschmitt_Me_109.jpg" aspect="1.447" caption="Messerschmidt 109" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/5f170802-922a-4ff3-9636-011d3bc59c7e" aspect="1.333" caption="Former Barretts showroom on St Peter's Street" attribution="Michelle Crowther, by permission" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/62c0d182-6f60-4916-a824-c82f77e63c3a" aspect="1.333" caption="Former Barretts showroom, now being renovated" attribution="Michelle Crowther, by kind permission" %}

{% include embed/image.html src="https://stor.artstor.org/stor/8acd68ee-34f3-4208-8d83-69407ebfe847" aspect="1.333" caption="Site of former Barretts forecourt" attribution="Michelle Crowther, by kind permission" %}
