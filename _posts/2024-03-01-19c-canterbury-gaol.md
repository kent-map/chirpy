...
description: "This essay examines Canterbury Gaol in the nineteenth century, tracing how local imprisonment in East Kent evolved in response to prison reform, changing penal policy, and new disciplinary regimes. It explores prison labour, gendered work, punishment practices, and the architectural shift from associated to separate confinement within a developing national prison system."
author: Dr Maryse Tennant
date: 2024-03-01
categories: [ 19c ]
tags: [ Crime & punishment, Towns & cities, Politics & reform, Buildings & architecture ]
image: 
...
{% include embed/image.html src="https://stor.artstor.org/stor/8b87d15d-5d86-4784-ab72-8dad919689c2" aspect="1.333" caption="Letter to the Gaol, St Augustine's Canterbury" attribution="Martin Crowther" %}{: .right}

Essentially holding places, county gaols were run by the local authorities to confine people awaiting trial or before other forms of punishment, such as transportation, were carried out. Later ‘public works’ prisons, such as those at [Chatham]({{ site.baseurl }}/19c/19c-convicts-chatham/) and [Maidstone](Q213180), were developed as penal servitude replaced transportation from the 1850s. Canterbury’s new prison was also a House of Correction, however, and so confined petty offenders and vagrants sentenced to periods of up to two years hard labour. The largely nominal distinction between the two institutions was finally abolished in 1865 but local prisons, as many county gaols became known, continued to perform a dual role.[^ref3]  At any one time, therefore, Canterbury’s prison would contain a complex mix of inmates – petty and serious offenders; men and women; but also a large proportion of those who were technically innocent and still awaiting trial. 

{% include embed/image.html src="wc:Former_gaol%2C_Canterbury_-_geograph.org.uk_-_4225814.jpg" aspect="1.333" caption="Former Gaol, Canterbury" %}{: .right}
...
{% include embed/image.html src="wc:The_main_road_outside_the_Kent_and_Canterbury_Hospital%2C_Cant_Wellcome_L0006873.jpg" aspect="1.44" caption="The main road outside the Kent and Canterbury Hospital, Canterbury. Line engraving by G. Dawe after C. Dillon." %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/6e9cc957-61b9-4342-b8e2-ef7ae7980680" aspect="0.75" caption="Canterbury Prison" attribution="Michelle Crowther" %}{: .right}
...
{% include embed/image.html src="wc:page21-1050px-Prison_rules_%28convict_prisons%29_-_draft_of_rules_proposed_to_be_made_under_the_Prison_Act%2C_1898_%28IA_b22333770%29.pdf.jpg" aspect="0.594" caption="Prison rules (convict prisons) - draft of rules proposed to be made under the Prison Act, 1898" %}{: .right}
