---
title: "Kentish place-names and the literary imagination"
description: "This essay explores how Kentish place-names carry cultural and imaginative meaning, shaping how readers and writers conjure landscape and belonging. It traces the historical origins of local toponyms and shows how authors and filmmakers use, adapt, or invent them to build believable literary geographies, illustrated through mapped examples across Kent and the Kent-Sussex borderlands."
author: Professor Peter Vujakovic
date: 2024-03-01
categories: [ landscape ]
tags: [ Literary places, Maps & place-making, Representation & interpretation, Rivers & marshes ]
image: 
...
{% include embed/image.html src="https://stor.artstor.org/stor/7e218701-0f35-4843-86f1-a3965d107e82" aspect="1.527" caption="St Nicholas at Wade, on the path from Potton Street towards Minnis through the Wantsum" attribution="Lisa Hawkins" %}{: .right}
...
{% include embed/map.html center="Q725261" zoom="12" markers="Q725261" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}

The Kentish toponyms typical of the region, adopted or adapted by writers, originate from various phases of settlement, although most are of ‘Old English’ origin. Some pre-Roman names do exist, more often the names of natural features such as rivers. The [Darent](Q2778973), for example, is thought to derive from the Welsh Derw, which the Romans latinized as ‘Derventio’ – “the river where oaks are common".  The county’s own name has an early origin (Roman ‘Cantium’), while a limited number of village and town names are Celtic, for example Penge (pen + ced, ‘wood’s end’), and [Dover](Q179224) (from ‘Dubras’ ‘the waters’).  

{% include embed/map.html center="Q2778973" zoom="12" markers="Q2778973" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}
...
Little Ansdore Farm was on [Walland Marsh](Q16902864), three miles from Rye, and about midway between the villages of Brodnyx and [Pedlinge](Q3373984). It was a sea farm. 

The farm that identifies with Little Ansdore seems to be either Little or Old Cheyne Court, which do lie about three miles east of Rye, but Brodnyx is a tiny settlement near [St Mary in the Marsh](Q7594628) some way off, while Pedlinge sits above the marsh near [Hythe](Q967166). Other anomalies occur throughout the text, although the sense of the three Marshes (Romney, Walland, and Denge) is retained. The church that Godden attends is described as at Brodnyx, while its very distinctive feature, discussed in the text, a bell-tower separate from the main church building is in reality that at [Brookland](Q2177760) (which is more logically the church close to ‘Little Ansdore’. Incidentally, the name Godden has a Kentish connection, [Godden Green](Q3109687), a hamlet a mile east of [Sevenoaks](Q939838).  

{% include embed/image.html src="wc:St_Augustine%2C_Brookland-_bell_tower.JPG" aspect="1.336" caption="Brookland bell tower" %}{: .right}

{% include embed/map.html center="Q16902864" zoom="11" markers="Q16902864" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}

The fictional ‘Chillingbourne’ immediately evokes a stream-side settlement for those who know Kent. ‘Chillingbourne’ was chosen by Pressburger and Powell as the name for the village in which the action of their film _A Canterbury Tale_ (1944) takes place. The images of the village in their film is an amalgam of several other villages in East Kent, including [Chilham](Q1004824), [Fordwich](Q2177468) and [Wickhambreaux](Q3092462). Michael Powell grew up in East Kent and place-names ending in ‘bourne’ (Old English (OE) ‘burna’ = stream) would have been extremely familiar. He was born in Bekesbourne, one of several similarly named settlements (Bishopsbourne, [Patrixbourne](Q7148079), [Littlebourne](Q2680610)) along a short stretch of the river Little Stour, itself known as the Nailbourne in its upper reaches. ‘Chillingbourne’ draws on the name element in Chilham, and so becomes ‘the stream of the family or followers of Cilla or Cille’ (OE). 

{% include embed/image.html src="wc:Chilham_-_geograph.org.uk_-_2210842.jpg" aspect="1.564" caption="Chilham" %}{: .right}

{% include embed/map.html center="Q1004824" zoom="12" markers="Q1004824" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}

[Charles Dickens]({{ site.baseurl }}/dickens/dickens-biography) famously conjured with toponyms, some tending to the humorous – for example the wonderfully named ‘Dingley Dell’ in Dickens’ _Pickwick Papers_. ‘Dingley Dell’ entered notaphilic history in the 1990s with the issue of the Bank of England’s £10 note that featured a portrait of Dickens with, as its background scene, ‘The cricket match Dingley Dell against All Muggleton’; Muggleton being [Maidstone](Q213180). The latter fictive toponym is celebrated in the naming of a J D Wetherspoon public house, the ‘Muggleton Inn’ in the county town’s High Street. Other places get relabelled, although not always in keeping with a Kentish vibe, as in the case of [Rochester](Q507517) becoming a rather unimaginatively renamed ‘Cloisterham’ in the _Mystery of Edwin Drood_. See other essays on [Dickens]({{ site.baseurl }}/dickens/) for further detailed treatment of other Kentish places. 

{% include embed/image.html src="wc:Robert_William_Buss_-_The_Pickwick_Papers%2C_a_game_of_cricket.jpg" aspect="0.795" caption="The Pickwick papers - a game of cricket" %}{: .right}

{% include embed/map.html center="Q213180" zoom="12" markers="Q213180" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}
...
{% include embed/image.html src="wc:Dymchurch_beach_-_geograph.org.uk_-_5878827.jpg" aspect="1.499" caption="Dymchurch Beach" %}{: .right}

{% include embed/map.html center="Q2796278" zoom="12" markers="Q2796278" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}
...
{% include embed/map.html center="Q1506093" zoom="12" markers="Q1506093" allmaps="3cec6f180298eeb9~Mudge 1801" %}{: .right}
