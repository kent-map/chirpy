...
date: 2024-03-01
categories: [ 19c ]
tags: [ Politics & reform, Authors & lives, Towns & cities, Identity & community ]
image: 
...
{% include embed/image.html src="wc:Josephine_Butler_bust_%2826484385992%29.jpg" aspect="0.75" caption="Josephine Butler, LSE Library, No restrictions, via Wikimedia Commons" %}{: .right}

<!-- Base map centred on Boughton Malherbe -->

{% include embed/map.html center="Q2161900" zoom="9.5" markers="Q2161900" allmaps="9537d136c6cd0dac~Kent Railway Map" %}{: .right}
...
{% include embed/image.html src="wc:Photograph_of_Josephine_Butler_c._1880_%2822795738651%29.jpg" aspect="0.622" caption="Josephine Butler c. 1880, LSE Library, No restrictions, via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/c87a31b4-b490-41f8-930c-97b5b9e7a5b0" aspect="1.567" caption="Maidstone" %}{: .right}

<!-- Base map centred on Maidstone -->

{% include embed/map.html center="Q213180" zoom="13" markers="Q213180" allmaps="9537d136c6cd0dac~Kent Railway Map" %}{: .right}
...
{% include embed/image.html src="wc:Poster_-_Josephine_Butler_Centenary._A_special_service_of_commemoration%2C_1928._%2822893825576%29.jpg" aspect="0.655" caption="Josephine Butler Centenary, LSE Library, No restrictions, via Wikimedia Commons" %}{: .right}
