...
description: "This essay traces Deal’s long military history from Julius Caesar’s attempted landings through medieval coastal defence, Tudor fortifications, the Civil War, and the Royal Marines’ centuries-long presence. It foregrounds Deal’s strategic position on the Kent coast and the Downs, showing how invasion threats, naval warfare, and wartime home-front measures shaped the town’s landscape and community."
author: Liam Cohen
date: 2024-03-01
categories: [ placesad ]
...
{% include embed/image.html src="https://stor.artstor.org/stor/9a5975c8-3fc2-4974-b85a-3c666bcb5ad4" aspect="1.538" caption="Rough Sea at Deal" attribution="Kent Maps Online Collection" %}{: .right}
...
{% include embed/image.html src="wc:Plate_1-_Julius_Caesar_looking_to_the_right%2C_from_%27The_Twelve_Caesars%27_MET_DP846534.jpg" aspect="0.717" caption="Julius Caesar Looking to the right" %}{: .right}
...
{% include embed/image.html src="wc:lossy-page1-1212px-A_draught_of_the_Goodwin_Sands_Pl.XXII_P169_RMG_A8031-D.tiff.jpg" aspect="1.183" caption="A draught of the Goodwin Sands" %}{: .right}
...
{% include embed/image.html src="wc:lossy-page1-1197px-Seamen_painting_a_jolly_boat_%28Bray_album%29_RMG_PT1984.tiff.jpg" aspect="1.169" caption="Seamen painting a jolly boat - Bray Album" %}{: .right}
...
{% include embed/image.html src="wc:Catherine_Aragon_Henri_VIII_by_Henry_Nelson_ONeil.jpg" aspect="1.282" caption="Catherine of Aragon pleads her case against divorce from Henry VIII" %}{: .right}
...
{% include embed/image.html src="wc:thumbnail.jpg" aspect="3.36" caption="Dealam Castrum et Sandvicum" %}{: .right}

{% include embed/image.html src="wc:Deal_Castle_1539_draft.jpg" aspect="0.863" caption="Deal Castle, 1539" %}{: .right}
...
{% include embed/image.html src="wc:Site_of_Sandown_Castle%2C_Deal_-_geograph.org.uk_-_4436351.jpg" aspect="1.333" caption="Site of Sandown Castle" %}{: .right}
...
{% include embed/image.html src="wc:King_Charles_I_by_Gerrit_van_Honthorst_sm.jpg" aspect="0.831" caption="King Charles I" %}{: .right}
...
{% include embed/image.html src="wc:Royal_Marines_Band_Drum_MOD_45155555.jpg" aspect="0.664" caption="Royal Marines Band Drum" %}{: .right}
...
{% include embed/image.html src="wc:Deal_Barracks_Bombing_memorial_garden.jpg" aspect="0.562" caption="Deal Barracks Bombing Memorial Gardens" %}{: .right}
...
{% include embed/image.html src="wc:Ex%C3%A9cution_de_Louis_XVI_Carnavalet.jpg" aspect="1.5" caption="Execution of Louis XVI" %}{: .right}
...
{% include embed/image.html src="wc:Loss_of_HMS_Aboukir%2C_Royal_Navy%2C_artwork_by_Norman_Wilkinson_%2819597630639%29.jpg" aspect="1.649" caption="Loss of HMS Aboukir" %}{: .right}
...
{% include embed/image.html src="wc:British_Battleships_of_the_First_World_War_Q40389.jpg" aspect="1.342" caption="HMS Vanguard, British Battleships of the First World War" %}{: .right}
...
{% include embed/image.html src="wc:The_Clarendon_Hotel%2C_Beach_Street%2C_Deal_-_geograph.org.uk_-_1718083.jpg" aspect="1.333" caption="The Clarendon Hotel, Beach Street, Deal" %}{: .right}
...
{% include embed/image.html src="wc:Walmer_Lifeboat_Charles_Dibdin.jpg" aspect="1.575" caption="Postcard of lifeboat Charles Dibdin at the Lifeboat Station, Walmer, before 1948" %}{: .right}
...
{% include embed/image.html src="wc:Deal_Walmer_Sandown_Saunders_Guidebook_Page005.jpg" aspect="0.549" caption="Saunders Guidebook, p.5" %}{: .right}
