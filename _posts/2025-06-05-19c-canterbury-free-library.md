...
description: "This essay traces the establishment and evolution of Canterbury Free Library from its 1858 origins under the 1850 Library Act through later expansions and controversies over access and acceptable reading. It focuses on the library as a civic institution in Canterbury, showing how rules, catalogues, and lending systems shaped public reading habits and debates about popular fiction."
author: Professor Carolyn Oulton
date: 2025-06-05
categories: [ 19c ]
tags: [ Culture & society, Towns & cities, Texts & genres, Politics & reform ]
image: 
...
{% include embed/image.html src="wc:Beaney_House_of_Art_and_Knowledge_2015.JPG" aspect="1.038" caption="Beaney Institute by Geni, CC BY-SA 4.0, via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="wc:James_George_Beaney_001.jpg" aspect="0.753" caption="James George Beaney" %}{: .right}

Braddon had clearly been forgiven by this point, as six of her novels appear in the new catalogue (including her most famous _Lady Audley’s Secret_ and _Aurora Floyd_). The catalogue also features five novels by [Wilkie Collins]({{ site.baseurl }}/19c/19c-collins-biography), as well as popular fiction by Rhoda Broughton, Ouida, Ellen Wood and Marie Corelli. The library continued to add titles by Braddon and Collins until at least 1911. Despite her status as a Kent resident, [Sarah Grand]({{ site.baseurl }}/19c/19c-grand-biography) seems to have counted as a bridge too far – not one of her novels appears in these catalogues.

{% include embed/image.html src="wc:Lady_Audleys_Secret_Cover.jpg" aspect="0.658" caption="Lady Audley's Secret" %}{: .right}

The continued use of an ‘indicator’ in 1915 suggests the continuing control exerted over readers. This device was based on a system of shutters that opened and closed to show if a book was available for borrowing. Crucially, the indicator was only necessary under the old Victorian system, whereby readers found a book in the catalogue and then requested it from the librarian. It had been superseded by the open access system in [Folkestone]({{ site.baseurl }}/19c/19c-folkestone-free-library/) by 1910. In less draconian mode, in the same year the [Canterbury]({{ site.baseurl }}/20c-canterbury-home) library opened its reading rooms on Sunday evenings for the sole use of soldiers. In an intriguing comment on the presence of WW1 combatants in the city, the librarian ‘stated that he had not had a single complaint from the soldiers, who had acted as gentlemen.’

{% include embed/image.html src="wc:Beaney_Institute_1899-1918_002.jpg" aspect="0.715" caption="Beaney Institute" %}{: .right}
...
{% include embed/image.html src="wc:James_George_Beaney_memorial_02.JPG" aspect="1.333" caption="James George Beaney Memorial" %}{: .right}

### Bibliography 

28th annual report. Folkestone Free Library 1909-10. Uncatalogued ephemera box. Folkestone Library.   
_The Beaney Bookplate 1899: Explored and Explained by Alan Barber_. Tales from the Magazine Room: Book 4. Unpaginated. [Canterbury Library](Q26370404). C741.69.   
