...
description: "This essay traces how Canterbury became a leading centre of education in the 20th century, from historic cathedral learning traditions to the expansion of schools and new campuses across the city. It explores key institutions including King’s School, the Simon Langton grammar schools, and independent schools, linking educational change to war damage, post-war rebuilding, and planning decisions."
author: Richard Maltby
date: 2024-03-01
categories: [ canterbury ]
tags: [ Culture & society, Towns & cities, Time periods, Maps & place-making ]
image: 
...
{% include embed/map.html center="Q3360332" zoom="15" markers="Q3360332" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/67a31a8c-c065-4747-a259-131c9d72eddc" aspect="1.653" caption="South prospect at King's School" attribution="By kind permission of King's School, Canterbury" %}

{% include embed/image.html src="https://stor.artstor.org/stor/daff0204-9646-4c43-a2ec-5577eb6cca3e" aspect="1.326" caption="Mint Yard" attribution="Mint Yard, Kings School, Canterbury, c. 1900. By kind permission of King's School, Canterbury" %}

{% include embed/image.html src="https://stor.artstor.org/stor/a257cc7a-42ea-4a6d-a510-a0d88c551690" aspect="1.383" caption="Murray School House" attribution="Murray School House, Kings School, Canterbury, c. 1900. By kind permission of King's School, Canterbury" %}
...
{% include embed/image.html src="wc:Canterbury_norman_staircase.JPG" aspect="1.334" caption="Canterbury Cathedral's Norman Staircase" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/c7538ee6-6e4e-4321-a748-578148758e2a" aspect="1.691" caption="Mint Yard" attribution="Mint Yard, Kings School, Canterbury, 1976. By kind permission of King's School, Canterbury" %}
...
{% include embed/image.html src="wc:The_River_Stour_-_geograph.org.uk_-_773783.jpg" aspect="1.495" caption="The River Stour with views of the Dominican Priory" %}
...
{% include embed/map.html center="Q7519171" zoom="15" markers="Q7519171" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/c1364803-83ff-4c91-ad94-2c3903d4b135" aspect="1.58" caption="Simon Langton Schools" attribution="Published by H. J. Goulden, Canterbury, pre-1918" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/b6c45d8f-4472-4f55-884b-2d14cab76143" aspect="0.664" caption="Simon Langton Boys" attribution="© Carolyn Oulton, by kind permission" %}

{% include embed/image.html src="https://stor.artstor.org/stor/efb430e3-c025-4ddd-a976-bc985277273c" aspect="1.097" caption="Simon Langton Boys' School entrance" attribution="Simon Langton Boys' School, 1974. By permission of Simon Langton Boys' Grammar School" %}

{% include embed/image.html src="https://stor.artstor.org/stor/a5222b83-766a-49ce-a3e5-6ff598aecee5" aspect="1.347" caption="Simon Langton Girls" attribution="By kind permission of Simon Langton Girls' Grammar School" %}
...
{% include embed/map.html center="Q7721217" zoom="15" markers="Q7721217" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}
...
{% include embed/image.html src="wc:Barton_court.jpg" aspect="0.669" caption="Barton Court, main building" %}

{% include embed/map.html center="Q4865609" zoom="15" markers="Q4865609" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}
...
{% include embed/image.html src="wc:Chaucer_school_canterbury.jpg" aspect="1.497" caption="Chaucer School in 2013" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/0335f354-b193-43c7-859f-39df4b1965a1" aspect="1.546" caption="Postcard of Kent College" attribution="Postcard of Kent College, c.1930. By kind permission of Kent College" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/6ab759bd-834f-46a9-adda-72e1807f86b6" aspect="1.333" caption="St Edmund's School" attribution="© St Edmund's School, Canterbury, used with kind permission" %}

{% include embed/image.html src="https://stor.artstor.org/stor/8818c692-2db8-4bde-a586-ddeb030f7ca9" aspect="1.333" caption="St Edmund's School" attribution="© St Edmund's School, Canterbury, used with kind permission" %}

{% include embed/map.html center="Q7593000" zoom="15" markers="Q7593000" allmaps="dce10f1c411cebb1~Blaeu Kent 1665" %}
...
{% include embed/image.html src="wc:Plan_for_Wesleyan_College%2C_Canterbury_%283611603394%29.jpg" aspect="1.595" caption="Plan for Wesleyan College" %}
