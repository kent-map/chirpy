---
title: "St. John the Baptist, Small Hythe"
description: "This essay traces the history of St John the Baptist church at Small Hythe, from a late medieval chapel through its destruction by fire in 1514 and rebuilding with Low Countries brickwork and distinctive stepped gables. It highlights the church’s plain architectural form, rare interior fittings, and later cultural associations with Ellen Terry and artists connected to Small Hythe Place."
author: Andrew Vincent
date: 2024-03-01
categories: [ churches ]
tags: [ Buildings & architecture, Faith & belief, Coast & sea, Arts & performance ]
image: 
...
A short way from the historic town of [Tenterden](Q614560) lies the village of Small Hythe.  This village, although now completely landlocked, had close ties to the [Cinque Ports](Q748895) Confederation. Small Hythe was a famous shipyard in medieval times, using timber from the great Wealden Forest. Although it is difficult to imagine when looking at the modern landscape of Kent, the county used to be an archipelago of deep channels and small isles, the names of which exist to this day, such as the [Isle of Thanet](Q590422), and Small Hythe’s neighbour, the [Isle of Oxney](Q265523). 

{% include embed/image.html src="wc:St_John_the_Baptist_Church%2C_Small_Hythe%2C_Kent_-_geograph.org.uk_-_957959.jpg" aspect="1.485" caption="St John the Baptist Church, Small Hythe" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/62da9026-fd94-40de-9f54-ad63696fdc9e" aspect="0.75" caption="The view of the church from the south east. Note the stepped gables and heavy buttressing" attribution="Andrew Vincent" %}{: .right}

However, only eight years after this in 1514, a fire tore through Small Hythe, taking the chapel and half the village with it. After this, the current chapel was constructed. Built of bricks, with distinctly Dutch looking, stepped gables at each end, it is believed that both the bricks and builders were sourced from the Low Countries. The church itself has a very plain design, with no aisles, chancels, or additional altars. It does however, have some beautiful and rare treasures inside. The wainscot paneling around the church is believed to be some of the oldest oak paneling in the country. There are also some beautifully illuminated pieces along the walls of the church created by [Christopher St John]({{ site.baseurl }}/20c/20c-st-john-biography), who lived with [Edith Craig]({{ site.baseurl }}/20c/20c-craig-biography), the daughter of celebrated actress [Ellen Terry]({{ site.baseurl }}/20c/20c-terry-biography). 

{% include embed/image.html src="https://stor.artstor.org/stor/68c5b8c3-5fec-4cab-893b-5edf940aa5a7" aspect="0.75" caption="The view of the chancel screen and wainscotting from the high altar. Note how plain the carving is from this side of the screen, when viewed from the other side, it is highly decorative" attribution="Andrew Vincent" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/29dd64d3-531b-479f-b993-f0fc7c206cef" aspect="0.648" caption="Ellen Terry as Imogen" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/e1a56162-96fa-4e4c-af51-a481569d773c" aspect="0.75" caption="The view of the church from the west, showing the entrance and porch, as well as the figure of St John the Baptist set into a niche above the west window" attribution="Andrew Vincent" %}{: .right}
