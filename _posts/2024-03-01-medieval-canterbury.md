...
description: "This essay introduces a set of surviving medieval buildings in Canterbury, highlighting distinctive construction features such as reused Roman stone, timber-framing techniques, and rare domestic fittings. It also traces the city’s medieval hospitals and their later transformations into almshouses and civic institutions, linking architecture to changing urban needs."
author: Dr Sheila Sweetinburgh
date: 2024-03-01
categories: [ medieval ]
tags: [ Buildings & architecture, Towns & cities, Heritage & memory, Culture & society ]
image: 
...
{% include embed/image.html src="https://stor.artstor.org/stor/c35ac328-b487-48c8-b586-1e9610a5ef44" aspect="1.333" caption="St Mildred's Church, Canterbury" attribution="Martin Crowther" %}{: .right}
...
{% include embed/image.html src="wc:Pizza_Express_courtyard_-_geograph.org.uk_-_2910109.jpg" aspect="1.333" caption="Pizza Express Courtyard" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/c3b88c8c-59ca-4a33-ba74-8d9a448647e0" aspect="1.333" caption="Siesta" attribution="Martin Crowther" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/1738ab17-c2ac-4e27-bb5f-1d2dcf05925d" aspect="1.333" caption="Misericord in the upper chapel, Eastbridge Hospital" attribution="Michelle Crowther" %}{: .right}
...
{% include embed/image.html src="wc:St_Nicholas%27_Chapel%2C_Harbledown_%28capital%29.jpg" aspect="1.333" caption="St Nicholas Chapel, The Old Leper Church of St Nicholas, Harbledown" %}{: .right}
...
{% include embed/image.html src="wc:Heritage_Museum_building_Canterbury.jpg" aspect="1.333" caption="Formerly the Heritage Museum building" %}{: .right}
