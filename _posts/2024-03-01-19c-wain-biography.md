---
title: "Louis Wain"
description: "This essay traces the life and career of cat illustrator Louis Wain, focusing on his most productive years living in Westgate-on-Sea and his connections to local society and patrons. It follows his rise to fame through periodical illustration and postcards, alongside family responsibilities, financial hardship, and worsening mental ill health that led to institutional care in London."
author: Nick Evans
date: 2024-03-01
categories: [ 19c ]
...
{% include embed/image.html src="wc:Catwithacigar.jpg" aspect="0.675" caption="Cat with a cigar" %}
...
{% include embed/image.html src="wc:Our_artists_-_past_and_present_-_ILN_1892-0514-0016.jpg" aspect="0.733" caption="Various Illustrated London News staff, 1892" %}
...
{% include embed/image.html src="wc:A_group_of_cats_engaged_in_a_cycle-race_in_Hyde_Park%2C_London_Wellcome_V0023074.jpg" aspect="1.568" caption="CC BY 4.0" %}
...
{% include embed/image.html src="wc:Carol_Singing_by_Louis_William_Wain%2C_watercolor.jpg" aspect="1.429" caption="Carol Singing" %}
...
{% include embed/image.html src="wc:1905-04-04_front_Cat_car_crash.jpg" aspect="1.561" caption="Cat car crash, 1905" %}
...
{% include embed/image.html src="wc:Westgate_Bay_-_geograph.org.uk_-_1931362.jpg" aspect="2.827" caption="Westgate Bay" %}
...
{% include embed/image.html src="wc:L._Wain%27s_kaleidoscope_cat_II.jpg" aspect="0.771" caption="Kaleidoscope Cat, 1910s" %}
...
{% include embed/image.html src="wc:Wein_catpoker.jpg" aspect="1.58" caption="Cat poker" %}
...
{% include embed/image.html src="wc:A_cat_in_%22gothic%22_style._Gouache_by_Louis_Wain%2C_1925-1939._Wellcome_L0026931.jpg" aspect="0.693" caption="A cat in gothic style. Gouache by Louis Wain, 1925-1939. Wellcome L0026931" %}
...
{% include embed/image.html src="wc:Bethlem_Royal_Hospital_Main_building_view_1.jpg" aspect="1.5" caption="Bethlem Royal Hospital" %}
...
{% include embed/image.html src="wc:Three_cats_singing._Gouache_by_Louis_Wain%2C_1925-1939._Wellcome_L0026168.jpg" aspect="1.296" caption="Three cats singing. Gouache by Louis Wain 1925-1939. Wellcome L0026168" %}
