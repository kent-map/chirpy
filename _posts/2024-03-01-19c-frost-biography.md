...
description: "This essay offers a brief biography of the Chartist journalist and writer Thomas Frost, tracing his family background, relationships, and precarious literary career. It highlights how Kent’s coast, marshes, and towns shaped his travel writing and his Dickens-focused pilgrimage narrative In Kent With Charles Dickens."
...
{% include embed/image.html src="wc:Faversham_Creek_-_geograph.org.uk_-_2251391.jpg" aspect="1.333" caption="Faversham Creek" %}{: .right}

The essentially bohemian tendencies of the family are captured perfectly in Frost’s recollection that one night a cousin of his went missing, and at the end of six months had been given up for lost. While spending a few days at [Gravesend]({{ site.baseurl }}/19c/19c-gravesend) a precocious young Frost  decided on a visit to Northfleet. He walked round the churchyard, saw the chalk-pit (later the site of the [Rosherville Gardens]({{ site.baseurl }}/19c/19c-gravesend) – and ‘As the day was warm, the chalk-dust of the roads in that part of Kent is provocative of thirst’ and the sign of the [Leather Bottle]({{ site.baseurl }}/dickens/pickwick-papers-leather-bottle) swinging before a low-roofed, old-fashioned village inn, was suggestive of a cool mug of ale’,  he went in. On the way out he was amazed to encounter the missing man, who was working there as an ostler. The two went back in for another drink, and the cousin implored Frost not to say anything to his family – while he duly resurfaced a month later, it is not clear how he explained matters to his wife.

{% include embed/image.html src="https://stor.artstor.org/stor/5aae08bd-3755-49e9-b144-25809d990abe" aspect="1.5" caption="Leather Bottle" attribution="Benjamin Mortley" %}{: .right}
...
But when Frost and two friends decided that what they needed was a week’s holiday without their wives, there was ‘no difficulty in determining that our destination should be the coast of Kent.’  It seems inevitable that he should have written [_In Kent With Charles Dickens_](https://archive.org/details/cu31924028036212), although the writing seems to have lagged somewhat, taking at least three years and finally appearing in print only in 1880. Frost’s love of the author is indisputable, as he and his companions continue their ‘pilgrimage’ from [Gad’s]({{ site.baseurl }}/dickens/dickens-gads-hill) to the Rochester of [Pickwick]({{ site.baseurl }}/dickens/pickwick-papers) and [Drood]({{ site.baseurl }}/dickens/edwin-drood-curated-walk), and so on to [Canterbury]({{ site.baseurl }}/19c/19c-canterbury) Frost notes that one inspired dramatist,= has relocated Mr Peggotty’s encounter with a repentant Martha to the cathedral (possibly a reference to _The Deal Boatman_ by [F. C. Burnand[]({{ site.baseurl }}/19c/19c-burnand-biography). Here the party breaks up, and Frost goes on alone to [Deal]({{ site.baseurl }}/seascape/deal), [Dover]({{ site.baseurl }}/19c/19c-dover) and [Margate]({{ site.baseurl }}/19c/19c-margate). The book itself still makes engaging reading, and may have inspired the considerably more famous _Three Men in a Boat_ by [Jerome K. Jerome]({{ site.baseurl }}/19c/19c-jerome-biography) in 1889.  

{% include embed/image.html src="wc:Charles_Dickens_and_Rochester_%281880%29_%2814581635499%29.jpg" aspect="1.573" caption="Charles Dickens and Rochester by Robert Langton, Gad's Hill, 1880" %}{: .right}

It was probably during the Christmas of 1879 that Frost decided on a stay in Southborough, near [Tunbridge Wells](Q665489). He was sufficiently impressed  by ‘this pleasant and healthful place, which many visitors prefer to the larger and gayer town in its vicinity’ to call its surroundings ‘more picturesque than those of any other in which I have resided.’  He went on – of course - to write a guide book focused on Tunbridge Wells in 1881. 
...
{% include embed/image.html src="wc:Stewart_Cottage%2C_Southborough_Common_-_geograph.org.uk_-_1833495.jpg" aspect="1.488" caption="Stewart Cottage, Southborough Common" %}{: .right}
