...
description: "This essay examines how Early Medieval Canterbury reused Roman building materials and infrastructure after the end of Roman rule. It traces spolia in pre-Conquest churches and the city walls, and considers how Roman roads continued to shape movement and settlement around Canterbury."
author: Harvey Wallace
date: 2026-01-06
categories: [ built ]
tags: [ Buildings & architecture, Towns & cities, Material culture, Travel & mobility, Time periods ]
image: 
...
{% include embed/image.html src="wc:Canterbury%2C_St._Martin%27s_Church%2C_North_eastern_aspect_-_geograph.org.uk_-_6938619.jpg" aspect="1.5" caption="St Matines Church, 2021" %}{: .right}
...
{% include embed/image.html src="wc:St_Martins_Church_Norman_tower.jpg" aspect="1.333" caption="St Martins Church Norman tower" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/fb3f75e0-144d-4c2f-9ca1-0432d108e853" aspect="1.333" caption="St Martins Church 2022 South wall 2" attribution="Harvey Wallace, Public domain, via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="wc:St_Martins_South_wall_exterior.jpg" aspect="1.333" caption="St Martins Church South wall Exterior" %}{: .right}
...
{% include embed/image.html src="wc:East_wall_of_St_Mildred%27s_Church.jpg" aspect="1.333" caption="East wall of St Mildred" %}{: .right}
...
{% include embed/image.html src="wc:St_Augustine_Canterbury_St_Pancras_church2.JPG" aspect="1.778" caption="Remains of St Pancras church in St Augustine Abby" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/76321b82-4f3e-4ca8-99c7-149e1a8877ca" aspect="0.75" caption="Roman materials used in Queningate a part of the East side of Canterbury city wall" attribution="Harvey Wallace, Public domain, via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="wc:East_side_of_Canterbury_City_wall.jpg" aspect="1.333" caption="Roman materials used in the East side of Canterbury city wall" %}{: .right}
...
{% include embed/image.html src="wc:Canterbury_-_Bertha_Queen_of_Kent_-_geograph.org.uk_-_6635849.jpg" aspect="1.333" caption="Statue of Bertha Queen of Kent located in Lady Wootton's Green" %}{: .right}
...
{% include embed/image.html src="wc:Wall_of_St_Mary%27s_church%2C_North_Gate_Canterbury.jpg" aspect="1.333" caption="Remains of the North side of Canterbury city wall in the side of St Mary's" %}{: .right}
...
{% include embed/image.html src="wc:1911Watling_Street.png" aspect="1.534" caption="Route of the Roman roads that lead out of Canterbury overlaid on map of Roman Britain" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/32679105-93c3-49e0-a480-2f59b746b2ba" aspect="0.75" caption="Church of St Pancras 2025" attribution="Harvey Wallace, Public domain, via Wikimedia Commons" %}{: .right}
