...
description: "Gertrude Warden’s career moves from late-Victorian stage roles to prolific romance and mystery fiction shaped by travel, grief, and collaboration. Kent landscapes around Lympne, Sandling, Hythe, and the marshes anchor The Wooing of a Fairy and show how close observation of place feeds character and mood."
...
{% include embed/image.html src="wc:LympneCastle1830.jpg" aspect="1.693" caption="Lympne Castle, 1830" %}

{% include embed/image.html src="wc:Lympne_Castle%2C_Kent_-_geograph.org.uk_-_730491.jpg" aspect="1.502" caption="Lympne Castle, Kent" %}
...
{% include embed/image.html src="wc:The_School_for_Scandal_%28BM_1868%2C0808.5776_2%29.jpg" aspect="1.754" caption="The School for Scandal" %}

{% include embed/image.html src="wc:Lillie_Langtry.jpg" aspect="0.764" caption="Lillie Langtry" %}
...
{% include embed/image.html src="wc:Vaudeville_Theatre_London.jpg" aspect="0.667" caption="Vaudeville Theatre, London" %}
...
{% include embed/image.html src="wc:Portret_van_Florence_Warden%2C_RP-F-2001-7-1358E-15.jpg" aspect="0.727" caption="Florence Warden" %}
...
{% include embed/image.html src="wc:Castle_Close%2C_Lympne_-_geograph.org.uk_-_1413598.jpg" aspect="1.333" caption="Castle Close, Lympne" %}

On arrival at the railway station in Cranling (a hybrid of Cranbrook and Sandling) Hervey has to 'tramp it two miles and a half to the village of Lythinge on the brow of the hill.'[^ref11] It is likely the village is [Lympne](Q2056118) as the description of the church with its 'short square tower' crowns the summit of a grassy hill, and is two and a half miles to Sandling. Hervey stands 'for over an hour gazing over the wide-spreading marshes to the angry line of the sea beyond. And the charm and strangeness of the place sank deep into my heart'.[^ref12]  It is possible Gertrude had sought solace in the countryside after the death of her husband and that she is describing her feelings here.

{% include embed/image.html src="wc:St_Stephen%2C_Lympne%2C_Kent_-_geograph.org.uk_-_326052.jpg" aspect="1.19" caption="St Stephen, Lympne, Kent" %}

{% include embed/image.html src="wc:Sandling_Junction_station_%28postcard%29.jpg" aspect="1.63" caption="Sandling Junction Station, 1910s" %}

{% include embed/map.html center="Q7416406" zoom="15" markers="Q7416406" allmaps="08f8a4bca9b4dd3a~Kent Ordnance Survey 1860" %}
...
{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/kmo-forum-images/main/4ef7a1d3-e56d-464b-a53e-af0841504286.jpg" aspect="1.553" caption="School of Musketry, Hythe" %}

{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/kmo-forum-images/main/99116851-20a9-4b76-8cb3-7ddce7a43d3b.jpg" aspect="1.737" caption="Hythe Military Canal" attribution="Michelle Crowther" %}
...
{% include embed/image.html src="wc:Port_Lympne_%2837%29.JPG" aspect="1.778" caption="Lympne" %}

{% include embed/image.html src="wc:Martello_Towers_14_and_15.jpg" aspect="1.333" caption="Martello Towers near Hythe Ranges" %}
...
{% include embed/image.html src="wc:St_Stephen%2C_Lympne_2.JPG" aspect="0.75" caption="St Stephen's Church, Lympne" %}
...
{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/kmo-forum-images/main/e0d0f20a-3c3f-48db-ba79-f8fc85a1d38e.jpg" aspect="1.722" caption="Illustration on the front cover of The Wooing of a Fairy" attribution="British library, public domain" %}
...
{% include embed/image.html src="wc:Baroness_Emma_Orczy_%28Bassano%29.jpg" aspect="0.757" caption="Baroness Orczy" %}
