...
description: "This essay traces how 20th-century transport infrastructure reshaped Canterbury, from A2 road traffic and bypass schemes to park-and-ride and changing patterns of congestion. It also examines rail electrification, high-speed services, the closure and afterlives of branch lines, and links long-distance coach travel to Ian Fleming’s Bond mythology."
author: Richard Maltby
date: 2024-03-01
categories: [ canterbury ]
tags: [ Travel & mobility, Towns & cities, Work & industry, Time periods ]
image: 
...
Between 1900 and 1962 all traffic on the [A2](Q888603) from London to Dover passed through the High Street. At the mid-point of the pedestrianised High Street the 1950s traffic signs, pointing in opposite directions to the destinations of Dover and Chatham, can still be seen. From 1962 when the Rheims Way and ring road around the southern part of the city were completed, A2 traffic could go around the city walls. It was not until 1981 with the completion of the [Canterbury]({{ site.baseurl }}/canterbury/20c-canterbury-home) by-pass that east-west traffic was taken out of [Canterbury]({{ site.baseurl }}/canterbury/20c-canterbury-home)

{% include embed/image.html src="https://stor.artstor.org/stor/bd562c60-7fcd-435e-9c8d-d1a1a989a015" aspect="1.333" caption="A2 sign on the High Street" attribution="Martin Crowther" %}{: .right}

No plans for a north-south bypass to relieve flows on the [A28](Q279963) Ashford to Thanet radial were realised. Despite the provision of three Park and Ride sites at [Wincheap](Q8023755), the [Old Dover Road]({{ site.baseurl }}/dickens/david-copperfield-dover-road) and Sturry Road, [Canterbury](Q29303)’s road network in the late-20th century came under constant pressure, with up to 160,000 vehicles per day travelling to and from the city. In addition to peak hour commuter congestion the expansion of secondary and higher education generated additional traffic. The problem of unlocking the gridlock, particularly around the Wincheap roundabout, has so far defied the planners.

{% include embed/image.html src="wc:Wincheap_roundabout_-_geograph.org.uk_-_746820.jpg" aspect="1.334" caption="Wincheap Rounadabout" %}{: .right}
...
{% include embed/image.html src="wc:Bus_Station_-_geograph.org.uk_-_746935.jpg" aspect="1.249" caption="Whitefriars shopping centre and bus station" %}{: .right}
