...
{% include embed/image.html src="wc:Josephine_Butler_bust_%2826484385992%29.jpg" aspect="0.75" caption="Josephine Butler, LSE Library, No restrictions, via Wikimedia Commons" %}

{% include embed/map.html center="Q2161900" zoom="9.5" markers="Q2161900" allmaps="9537d136c6cd0dac~Kent Railway Map" %}
...
{% include embed/image.html src="wc:Vilhelm_Bille_-_Sejlb%C3%A5de_ud_for_Dovers_kyst.png" aspect="1.325" caption="Dover by Vilhelm Bille c. 1882-1908" %}

{% include embed/map.html center="Q2161900" zoom="9.5" markers="Q2161900" allmaps="9537d136c6cd0dac~Kent Railway Map" %}

Butler established the Ladies National Association for the Repeal of the Contagious Diseases Acts and published _An Appeal to the People of England_, by 'an English Mother', early in 1870. She argued that hospital admissions should be on a voluntary basis and that prostitutes should be examined by women doctors.  She began a nationwide campaign to repeal the act, giving talks in towns and cities up and down the country, including [Chatham](Q729006), [Whitstable](Q964785) and [Canterbury](Q29303). By the middle of June, Butler had travelled 3700 miles campaigning against the Acts.[^ref3]  

{% include embed/image.html src="wc:Photograph_of_Josephine_Butler_c._1880_%2822795738651%29.jpg" aspect="0.622" caption="Josephine Butler c. 1880, LSE Library, No restrictions, via Wikimedia Commons" %}

{% include embed/map.html center="Q3197107" zoom="10" markers="Q3197107" allmaps="9537d136c6cd0dac~Kent Railway Map" %}
...
{% include embed/image.html src="wc:Joshua_Cristall_-_Dover_Pier_-_B1977.14.5756_-_Yale_Center_for_British_Art.jpg" aspect="1.325" caption="Dover Pier, Joshua Cristall, CC0, via Wikimedia Commons" %}
...
{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/kmo-forum-images/main/c87a31b4-b490-41f8-930c-97b5b9e7a5b0.jpg" aspect="1.567" caption="Maidstone" %}
...
{% include embed/image.html src="wc:Poster_-_Josephine_Butler_Centenary._A_special_service_of_commemoration%2C_1928._%2822893825576%29.jpg" aspect="0.655" caption="Josephine Butler Centenary, LSE Library, No restrictions, via Wikimedia Commons" %}
