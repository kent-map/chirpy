...
description: "This essay explains the origins and development of the Cinque Ports confederation, focusing on Kent’s head ports and their associated limbs, and the rights and obligations tied to naval service for the crown. It also traces the civic rituals of mayor-making from medieval church-based elections to their later reform, showing how these traditions continue to shape local identity and ceremony."
...
{% include embed/image.html src="wc:Standard_of_the_Lord_Warden_of_the_Cinque_Ports_RMG_L0123.tiff" aspect="1.435" caption="Standard of the Lord Warden of the Cinque Ports RMG L0123" %}{: .right}
