...
description: "An overview of how Canterbury changed across the 20th century, from wartime bombing and post-war reconstruction to rapid expansion driven by population growth, education, tourism and retail. It highlights shifting land use, new housing and university campuses, and ongoing challenges around traffic and pollution as the city developed beyond its historic core."
...
{% include embed/image.html src="wc:Ruins_of_St_Augustines_Abbey.JPG" aspect="1.5" caption="Abbey Ruins" %}
...
{% include embed/image.html src="wc:Canterbury_map%2C_1610.png" aspect="0.982" caption="John Speed's depiction of Canterbury and the city walls, around 1610" %}
