...
description: "This essay traces the life and career of novelist and journalist William Pett Ridge, born in Chilham and shaped by railways, education, and literary networks that connected Kent and London. It links key places in his biography to themes in his fiction, including cockney life, rail travel, hop-picking, and cricket, and notes his later reputation and relative obscurity today."
...
William Pett Ridge, writer and ‘friend of the cockneys’ was born at [Chilham](Q1004824), near [Canterbury]({{ site.baseurl }}/19c/19c-canterbury) on 22 April 1859. He was the son of James Ridge and Elizabeth Pett. James who possibly worked at the Chilham railway station which had opened in 1846, became the station master at [Chartham](Q2743911) on the Ashford-Ramsgate line when it opened on November 1 1859.[^ref1] The family lived at Nackholt Cottages 

At some point after 1865, James became station master at [Marden](Q6758628) and it was here that William received his 'abridged' education with his siblings Frederick, Francis and Annie.[^ref2] By the age of 14, his brother Frederick was a telegraph clerk.

{% include embed/image.html src="wc:Chartham_Signalbox_-_geograph.org.uk_-_4844642.jpg" aspect="1.502" caption="Chartham Signalbox" %}{: .right}

It was whilst he was living at Marden, that Pett Ridge recalls visiting [Gad’s Hill]({{ site.baseurl }}/dickens/dickens-gads-hill), the home of [Charles Dickens]({{ site.baseurl }}/dickens/dickens-biography).
...
Later, as an adult, Pett Ridge wrote a short sketch for the _Illustrated London News_ entitled ‘The return of the Master’ about the ghost of [Dickens]({{ site.baseurl }}/dickens) wandering the streets of London and he also became a member of the Boz Club where 'subjects of Dickensian interest' were discussed.[^ref4] His stories of cockney life earned him the nickname of the Dickens of the 20th century.[^ref5]

{% include embed/image.html src="wc:Engraving_of_Dickens_at_Gad%27s_Hill%2C_Samuel_Hollyer.png" aspect="1.454" caption="Engraving of Dickens at Gad's Hill" %}{: .right}

It was whilst he was living at Marden that Pett Ridge was called out of school to play cricket against W.W. Rodgers, one of Kent’s first class cricketers. Pett Ridge recalls that Rodgers got drunk on cider and slept through most of the game. Pett Ridge also saw W.G. Grace play for Gloucestershire at [Canterbury]({{ site.baseurl }}/19c/19c-canterbury), and although Kent lost, Pett Ridge recalls that he and his brother “danced the whole way home”.[^ref6]

{% include embed/image.html src="wc:WG_Grace_c1902.jpg" aspect="0.835" caption="W.G. Grace, c.1902" %}{: .right}

In late 1871, James Ridge received a promotion to become station master at [Paddock Wood](Q2152461).[^ref7]   He was fatally injured just over a year later when he was hit by the London and [Dover]({{ site.baseurl }}/19c/19c-dover) night mail train, leaving Elizabeth a widow with five children.[^ref8]  William Pett Ridge was not yet 14 but joined the South East Railway as a Clerk and later became a Clerk in the Continental Goods Office of the railway. He wrote:
...
{% include embed/image.html src="wc:Paddock_Wood_Junction_station_%28postcard%29.jpg" aspect="1.621" caption="Paddock Wood Junction c. 1910s" %}{: .right}
...
{% include embed/image.html src="wc:W._Pett_Ridge_LCCN2014715293.jpg" aspect="0.728" caption="W. Pett Ridge" %}{: .right}

Pett Ridge soon became acquainted with authors such as [Jerome K. Jerome]({{ site.baseurl }}/19c/19c-jerome-biography), Arnold Bennett and [H.G. Wells]({{ site.baseurl }}/20c/20c-wellshg-biography), whom he visited at [Sandgate]({{ site.baseurl }}/placesqz/sandgate-overview). Bennett wrote to Wells  'I am much too vain to mind being called “not a poet”, and “not a genius”. But to be called a “dear delightful person” rouses my worse instincts. It makes me feel as if I were like Marriot Watson or Pett Ridge, and I ain’t, not really.'[^ref12] 
...
{% include embed/image.html src="https://stor.artstor.org/stor/335d901a-8416-4356-8a12-1607c997a9a2" aspect="1.586" caption="Hop-picking" attribution="C. Essenhigh Corke, 1906, J. Salmon, Sevenoaks" %}{: .right}
...
Four of Pett Ridge's books were adapted as films by Eliot Stannard, the son of [Henrietta Vaughan Stannard]({{ site.baseurl }}/19c/19c-vaughan-stannard-biography)

{% include embed/image.html src="wc:Wanhurst_Oast_House%2C_Battle_Road%2C_Wanhurst_Green%2C_Marden%2C_Kent_-_geograph.org.uk_-_629053.jpg" aspect="0.681" caption="Wanhurst Oast House, Wanhurst Green, near Marden" %}{: .right}

Pett Ridge died at his home in [Chislehurst](Q122917) on the 29 Sep 1930 aged 71.[^ref17] His work is largely forgotten today.

This article was published: 20 August 2023.

{% include embed/image.html src="wc:page1-485px-%22Erb%22_%28IA_erb00ridg%29.pdf.jpg" aspect="0.632" caption="Cover of Erb" %}{: .right}
