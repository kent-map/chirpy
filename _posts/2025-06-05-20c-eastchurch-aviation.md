...
description: "This essay traces how the Isle of Sheppey, especially Shellness and Eastchurch, became a cradle of British aviation through the work of the Wright brothers’ collaborators, the Short brothers, and the Royal Aero Club. It follows the shift from pioneering civilian experiments and early manufacturing to naval and military aviation in the First World War and later conflicts, and considers how the island’s aviation heritage is remembered through memorials and the Eastchurch Aviation Museum."
...
The [Isle of Sheppey](Q1500299) off the north Kent coast, best known for its dockyard, three prisons and various holiday sites, holds a distinguished place in history for a very different reason.   On this small island in the early 20th century, aviation in Britain was born.   

{% include embed/image.html src="wc:Isle_of_Sheppey_from_Space_NASA.jpg" aspect="1.401" caption="Isle of Sheppey from Space NASA" %}{: .right}

{% include embed/map.html center="Q1500299" zoom="12" markers="Q1500299" allmaps="6215fa6c47c47347~Bartholomew Kent 1904" %}{: .right}
...
{% include embed/image.html src="wc:The_Wright_Brothers%3B_first_powered_flight_HU98267.jpg" aspect="1.414" caption="The Wright Brothers; first powered flight" %}{: .right}
...
{% include embed/image.html src="wc:Ballooning_at_Monmouth_Gasworks.jpg" aspect="1.444" caption="Ballooning at Monmouth Gasworks, Charles Rolls in the basket" %}{: .right}
...
{% include embed/image.html src="wc:Short_Brothers_statue_at_Leysdown_Country_Park_-_geograph.org.uk_-_4428292.jpg" aspect="1.333" caption="Short Brothers statue at Leysdown Country Park - geograph.org.uk" %}{: .right}
...
{% include embed/image.html src="wc:Aeromanualf83p89.png" aspect="1.762" caption="Mr.J.T.C.Moore-Brabazon on Bird of Passage at Issy, November, 1908" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/4e1b5042-80c1-434f-90bf-7f4daecbdbac" aspect="1.279" caption="Founding Fathers of Aviation at Muswell Manor May 1909" attribution="With kind permission of Eastchurch Aviation Museum" %}{: .right}

With a production team of 80 and Horace’s brilliant engineering mind, the Shorts soon developed their own design and in October 1909,[^ref18] JTC Moore-Brabazon achieved another first by becoming the **first** person in Britain to fly a circular mile in a British-built machine, a Short No. 2, winning £1000 prize money for the Daily Mail challenge;[^ref19]  this flight took place at the Shellness airfield at Leysdown. Later that day, Moore-Brabazon flew for four miles over to [Eastchurch](Q2661688) and back, winning the British Empire Michelin Cup for the longest flight in an English machine.[^ref20] In 1910, he was awarded the Aero Club’s Pilot’s certificate No. 1.[^ref21]  

{% include embed/image.html src="https://stor.artstor.org/stor/c75be350-4a09-4e99-b1c2-b91b40766f91" aspect="1.754" caption="Short No. 2 model on display at Eastchurch Aviation Museum" attribution="With kind permission of Eastchurch Aviation Museum" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/05b98e5c-5c10-4e6f-b53d-1fa56d84cdc7" aspect="0.644" caption="JTC Moore-Brabazon’s lucky bracelet and crucifix on display at Eastchurch Aviation Museum" attribution="With kind permission of Eastchurch Aviation Museum" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/93ef3174-51d5-4da4-88a5-145c47529f4f" aspect="1.66" caption="Picture of Eastchurch Aeroshed under construction 1911 and Short Brothers Factory Sheds transferred from Shellness Flying Ground" attribution="With kind permission of Eastchurch Aviation Museum" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/7ec5f7b0-ef9b-405c-9ab7-d67886e7b226" aspect="1.591" caption="Gordon Bennet Aviation Race, Eastchurch, July 1911" attribution="With kind permission of Eastchurch Aviation Museum" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/dc912e13-12e6-4965-b7f7-d2e4ca2762c9" aspect="0.738" caption="Illustrated London News coverage of Frank McClean's flight up the Thames, on display at Eastchurch Aviation Museum" attribution="With kind permission of Eastchurch Aviation Museum" %}{: .right}
...
{% include embed/image.html src="wc:Winston_Churchill_With_Naval_Wing_of_the_Royal_Flying_Corps%2C_1914._CH4778.jpg" aspect="1.684" caption="Winston Churchill With Naval Wing of the Royal Flying Corps, 1914" %}{: .right}
...
{% include embed/image.html src="wc:The_Royal_Naval_Air_Service_%28rnas%29_1914-1918_Q58422.jpg" aspect="1.394" caption="The Royal Naval Air Service 1914-1918 at Eastchurch" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/a339a624-e920-4a49-851f-ec86499a3448" aspect="0.624" caption="Christmas 1943 RAF Eastchurch menu" attribution="With kind permission of Eastchurch Aviation Museum" %}{: .right}
...
{% include embed/image.html src="wc:Aircraft_monument%2C_Eastchurch_-_geograph.org.uk_-_1404737.jpg" aspect="1.333" caption="Aircraft monument, Eastchurch - geograph.org.uk" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/cb73cba9-48af-49bc-b8e0-e5f24d9c1fa0" aspect="1.787" caption="Eastchurch Aviation Museum" attribution="With kind permission of Eastchurch Aviation Museum" %}{: .right}
...
{% include embed/image.html src="wc:British_Aviation_Prior_To_the_First_World_War_Q67032.jpg" aspect="1.394" caption="British Aviation Prior To the First World War" %}{: .right}
