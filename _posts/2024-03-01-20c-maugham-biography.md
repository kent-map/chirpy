...
{% include embed/image.html src="wc:William_Somerset_Maugham_1965.jpg" aspect="0.75" caption="William Somerset Maugham 1965" %}{: .right}

{% include embed/image.html src="wc:Mint_Yard_Canterbury.jpg" aspect="1.333" caption="King’s School in Canterbury" %}{: .right}

<!-- Base map centered on Blean -->

{% include embed/map.html center="Q2741069" zoom="11" markers="Q2741069" allmaps="5aa3ce47b380271b~Kent Road Map" %}{: .right}

{% include embed/map.html center="Q3360332" zoom="11" markers="Q3360332" allmaps="5aa3ce47b380271b~Kent Road Map" %}{: .right}

{% include embed/map.html center="Q29303" zoom="11" markers="Q29303" allmaps="5aa3ce47b380271b~Kent Road Map" %}{: .right}

{% include embed/map.html center="Q964785" zoom="11" markers="Q964785" allmaps="5aa3ce47b380271b~Kent Road Map" %}{: .right}
...
{% include embed/image.html src="wc:The_Mint_Yard_Gate%2C_Kings_School%2C_Canterbury_-_geograph.org.uk_-_67733.jpg" aspect="1.285" caption="The Mint Yard Gate, Kings School, Canterbury" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/a9e1fd3b-ac85-4b33-b6c5-8070e012f639" aspect="0.709" caption="Somerset Maugham" attribution="Photograph of lino print by kind permission of Ben Dickson" %}{: .right}
...
{% include embed/image.html src="wc:Great_Stour_at_Canterbury_-_geograph.org.uk_-_1987472.jpg" aspect="1.333" caption="Great Stour at Canterbury" %}{: .right}

<!-- Base map centered on Honey Hill -->

{% include embed/map.html center="Q3140008" zoom="12" markers="Q3140008" allmaps="5aa3ce47b380271b~Kent Road Map" %}{: .right}
...
{% include embed/image.html src="wc:Cobbled_Street_in_Whitstable.jpg" aspect="1.333" caption="Whitstable Town" %}{: .right}
