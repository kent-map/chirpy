...
description: "This essay explores how Russell Hoban’s Riddley Walker reshapes Kentish place-names to evoke a post-apocalyptic landscape and to restore meaning to names that can become mere sounds. It reads Riddley’s hand-drawn map as a form of authority and biography, tracing how altered toponyms connect language, memory, and changing coastlines in and around Canterbury, the Stour, and Dungeness."
...
![A post-apocalyptic landscape with just blackened trees, rocks and scorched earth](https://stor.artstor.org/stor/dd5d9724-2e6a-4d52-9f74-d5d29db02db6)
_A post-apocalyptic landscape with just blackened trees, rocks and scorched earth_
{: .right}

His toponyms gain authority through cartographic representation – maps are power. His map shows a landscape impacted by sea-level change, the ‘Rivver Sour’ is now a tidal estuary as far inland as ‘Cambry’ ([Canterbury](Q29303)), the Isle of Thanet is once again a real island (named the ‘The Ram’ after the town of Ramsgate), and the far tip of Dungeness is cut-off from the mainland (although retains its twentieth-century position and outline, an unlikely outcome after such a period of constant erosion and deposition). This new coastline is, in fact, a return to that of the late Iron Age and Roman eras. 
...
![Dungeness view to the NW from the Old Lighthouse](https://upload.wikimedia.org/wikipedia/commons/f/f0/Dungeness_-_view_to_the_NW_from_the_Old_Lighthouse_-_geograph.org.uk_-_2340756.jpg)
_Dungeness view to the NW from the Old Lighthouse_
{: .right}
...
{% include embed/map.html center="Q632173" zoom="15" marker="true" %}{: .right}
...
{% include embed/map.html center="Q3135780" zoom="15" marker="true" %}{: .right}
