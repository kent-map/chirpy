...
description: "This essay presents a biographical account of the actor and novelist Gertrude Warden, tracing her career from the Victorian stage to a prolific output of romance and mystery fiction. It links her personal losses and creative practice to Kent locations in and around Lympne, Hythe, and the marshland and coast that shaped the setting of her novel The Wooing of a Fairy."
...
{% include embed/image.html src="wc:LympneCastle1830.jpg" aspect="1.693" caption="Lympne Castle, 1830" %}{: .right}
...
{% include embed/image.html src="wc:Lillie_Langtry.jpg" aspect="0.764" caption="Lillie Langtry" %}{: .right}
...
{% include embed/image.html src="wc:Vaudeville_Theatre_London.jpg" aspect="0.667" caption="Vaudeville Theatre, London" %}{: .right}
...
{% include embed/image.html src="wc:Portret_van_Florence_Warden%2C_RP-F-2001-7-1358E-15.jpg" aspect="0.727" caption="Florence Warden" %}{: .right}
...
{% include embed/image.html src="wc:Castle_Close%2C_Lympne_-_geograph.org.uk_-_1413598.jpg" aspect="1.333" caption="Castle Close, Lympne" %}{: .right}
...
{% include embed/image.html src="wc:St_Stephen%2C_Lympne%2C_Kent_-_geograph.org.uk_-_326052.jpg" aspect="1.19" caption="St Stephen, Lympne, Kent" %}{: .right}

{% include embed/image.html src="wc:Sandling_Junction_station_%28postcard%29.jpg" aspect="1.63" caption="Sandling Junction Station, 1910s" %}{: .right}

{% include embed/map.html center="Q7416406" zoom="15" markers="Q7416406" allmaps="08f8a4bca9b4dd3a~Kent Ordnance Survey 1860" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/4ef7a1d3-e56d-464b-a53e-af0841504286" aspect="1.553" caption="School of Musketry, Hythe" %}{: .right}

{% include embed/image.html src="https://stor.artstor.org/stor/99116851-20a9-4b76-8cb3-7ddce7a43d3b" aspect="1.737" caption="Hythe Military Canal" attribution="Michelle Crowther" %}{: .right}

{% include embed/map.html center="Q967166" zoom="15" markers="Q967166" allmaps="08f8a4bca9b4dd3a~Kent Ordnance Survey 1860" %}{: .right}
...
{% include embed/image.html src="wc:Port_Lympne_%2837%29.JPG" aspect="1.778" caption="Lympne" %}{: .right}

{% include embed/image.html src="wc:Martello_Towers_14_and_15.jpg" aspect="1.333" caption="Martello Towers near Hythe Ranges" %}{: .right}
...
{% include embed/image.html src="wc:St_Stephen%2C_Lympne_2.JPG" aspect="0.75" caption="St Stephen's Church, Lympne" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/e0d0f20a-3c3f-48db-ba79-f8fc85a1d38e" aspect="1.722" caption="Illustration on the front cover of The Wooing of a Fairy" attribution="British library, public domain" %}{: .right}
...
{% include embed/image.html src="wc:Baroness_Emma_Orczy_%28Bassano%29.jpg" aspect="0.757" caption="Baroness Orczy" %}{: .right}
