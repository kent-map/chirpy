...
description: "This essay introduces Charles Darwin as a prolific and gifted writer whose most influential works were produced during his long residence in Kent, especially at Down House in Downe. It links his scientific practice, experiments in his home grounds, and distinctive use of metaphor to his wider cultural impact on readers and the arts."
author: Peter Vujakovic
date: 2024-03-01
categories: [ 19c ]
tags: [ Authors & lives, Science & ideas, Buildings & architecture, Representation & interpretation ]
image: 
...
{% include embed/image.html src="wc:Charles_Darwin_by_Julia_Margaret_Cameron_3.jpg" aspect="0.743" caption="Charles Darwin, September 1868" %}{: .right}

{% include embed/map.html center="Q2019734" zoom="8" markers="Q2019734" allmaps="08f8a4bca9b4dd3a~Kent OS 1860" %}{: .right}
...
{% include embed/image.html src="wc:The_expression_of_the_emotions_in_man_and_animals_%281872%29_%2814762147996%29.jpg" aspect="0.967" caption="The Expressions of the Emotions in Man and Animals" %}{: .right}
...
{% include embed/image.html src="wc:Haeckel_Nepenthaceae.jpg" aspect="0.698" caption="Pitcher plant (Nepenthaceae: insectivorous)" %}{: .right}

It is interesting to note that Darwin is one of several writers with a strong Kent connection to feature on a Bank of England bank note. He displaced [Charles Dickens]({{ site.baseurl }}/dickens/dickens-biography) from the £10 note, before being in turn displaced by [Jane Austen]({{ site.baseurl }}/19c/19c-austen-biography) in 2017. The Austen note features [Godmersham Park]({{ site.baseurl }}/austen/austen-godmersham), on the Great Stour (south of Canterbury) as the backdrop. The estate was inherited by her brother in 1794 and she became a regular visitor. The Dickens note also featured a (fictional) Kentish scene – the cricket match Dingley Dell against All Muggleton (Maidstone) from [_The Pickwick Papers_]({{ site.baseurl }}/dickens/pickwick-papers). Other Kent literary and artistic connections include [Sir Winston Churchill]({{ site.baseurl }}/20c/20c-churchill-chartwell) on the £5 note and J.M.W. Turner on the £20 note.

{% include embed/image.html src="wc:Charles_Darwin%2C_English_naturlist%2C_colored.jpg" aspect="0.868" caption="Charles Darwin, English Naturalist" %}{: .right}
