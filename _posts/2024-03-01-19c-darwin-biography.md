...
description: "This essay explores Charles Darwin as a gifted and influential writer during his forty-year residence in Kent, highlighting how major works such as On the Origin of Species were shaped by his life and research at Down House in Downe. It connects his experiments, family life, and vivid metaphors to his wider impact on scientific thinking and the arts."
...
{% include embed/image.html src="wc:Charles_Darwin_by_Julia_Margaret_Cameron_3.jpg" aspect="0.743" caption="Charles Darwin, September 1868" %}

{% include embed/map.html center="Q2019734" zoom="8" markers="Q2019734" allmaps="08f8a4bca9b4dd3a~Kent OS 1860" %}
...
{% include embed/image.html src="wc:Tree_of_life_by_Haeckel.jpg" aspect="0.632" caption="Tree of Life" %}
...
{% include embed/image.html src="wc:Down_House.jpg" aspect="0.75" caption="Down House" %}
...
{% include embed/image.html src="wc:The_expression_of_the_emotions_in_man_and_animals_%281872%29_%2814762147996%29.jpg" aspect="0.967" caption="The Expressions of the Emotions in Man and Animals" %}
...
{% include embed/image.html src="wc:Haeckel_Nepenthaceae.jpg" aspect="0.698" caption="Pitcher plant (Nepenthaceae: insectivorous)" %}
...
{% include embed/image.html src="wc:Charles_Darwin%2C_English_naturlist%2C_colored.jpg" aspect="0.868" caption="Charles Darwin, English Naturalist" %}
