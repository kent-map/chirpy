...
description: "This essay traces how Canterbury’s heritage sites and cultural institutions were adapted across the 20th century to meet growing tourism and changing visitor expectations, from museums and theatres to curated historical attractions. It links civic redevelopment, new forms of interpretation, and major transport changes such as the Channel Tunnel to the evolving experience of the Cathedral precinct and the city centre."
author: Richard Maltby
date: 2024-03-01
categories: [ canterbury ]
tags: [ Heritage & memory, Towns & cities, Travel & mobility, Buildings & architecture, Time periods ]
image: 
...
{% include embed/image.html src="wc:High_Street%2C_Canterbury%2C_England_%2849976428122%29.jpg" aspect="1.402" caption="High Street, Canterbury" %}{: .right}
...
{% include embed/image.html src="wc:Westgate_Towers%2C_Canterbury_-_geograph.org.uk_-_4804969.jpg" aspect="1.501" caption="Westgate Towers, Canterbury" %}{: .right}
...
{% include embed/image.html src="wc:Eastbridge_Hospital_Canterbury_1085030_20230813_0147.jpg" aspect="1.5" caption="Tilman2007, CC BY-SA 4.0, via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="wc:Greyfriars_Chapel_-_geograph.org.uk_-_4142883.jpg" aspect="0.75" caption="Greyfriars Chapel by Kim Fyson, CC BY-SA 2.0 via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="wc:Museum_of_Canterbury_001.jpg" aspect="1.287" caption="Canterbury Heritage Museum" %}{: .right}
...
{% include embed/image.html src="wc:Canterbury_Beaney_Institute.JPG" aspect="0.728" caption="Beaney Institute, by Zeisterre, CC BY-SA 3.0 via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="wc:The_Smallfilms_Gallery_at_The_Beaney%2C_Canterbury%2C_August_2022_04.jpg" aspect="1.333" caption="The Smallfilms Gallery at the Beaney" %}{: .right}
...
{% include embed/image.html src="wc:Marlowe_Theatre%2C_Canterbury.jpg" aspect="1.39" caption="Marlowe Theatre" %}{: .right}
...
{% include embed/image.html src="wc:Sculpture_of_Dave_Lee_by_the_Marlowe_Theatre%2C_Canterbury_-_geograph.org.uk_-_5056644.jpg" aspect="0.75" caption="Sculpture of Dave Lee by the Marlowe Theatre" %}{: .right}
...
{% include embed/image.html src="wc:Canterbury_Tales_Museum_-_geograph.org.uk_-_1988188.jpg" aspect="0.75" caption="Canterbury Tales" %}{: .right}
...
{% include embed/image.html src="https://stor.artstor.org/stor/115f208d-182b-44f6-bf4d-8f481eea236d" aspect="1.0" caption="Geoffrey Chaucer Statue, Canterbury - sculpted by Sam Holland and Lynn O'Dowd, 2018" attribution="Martin Crowther" %}{: .right}
...
{% include embed/image.html src="wc:St_Augustine%27s_Abbey_and_Canterbury_Cathedral_-_geograph.org.uk_-_2771856.jpg" aspect="1.333" caption="Saint Augustine Abbey by Ruth Riddle, via Wikimedia Commons, CC BY-SA 2.0" %}{: .right}
...
{% include embed/image.html src="wc:St_Augustine%27s_Abbey%2C_Canterbury_%2834988961570%29.jpg" aspect="1.504" caption="St Augustine's Abbey, ijclark, CC BY 2.0, via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="wc:Canterbury_Cathedral_-_geograph.org.uk_-_3829028.jpg" aspect="0.666" caption="Canterbury Cathedral" %}{: .right}
...
{% include embed/image.html src="wc:Statue%2C_Christ_Church_Gate_-_geograph.org.uk_-_3468043.jpg" aspect="0.752" caption="Christ Church Gate by David Dixon, CC BY-SA 2.0 via Wikimedia Commons" %}{: .right}
...
{% include embed/image.html src="wc:Canterbury_Cathedral_Lodge_-_geograph.org.uk_-_5540668.jpg" aspect="1.506" caption="Canterbury Cathedral Lodge by Ian Taylor, CC BY-SA 2.0 via Wikimedia Commons" %}{: .right}
