---
title: "Crime Fiction"
description: "This essay surveys how Kent became a recurring setting for British crime fiction from the sensation novels of the railway age through the interwar Golden Age and into the aftermath of the Second World War. It links mysteries to travel by train and to holiday landscapes such as seaside resorts, Romney Marsh, and towns like Rochester, showing how place shaped the genre’s thrills."
...
{% include embed/image.html src="wc:Strand_paget.jpg" aspect="1.061" caption="The Strand Magazine, Dec 1892" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/4f0a08c9-36df-443c-93b1-ebf66c77bb6a" aspect="0.695" caption="Calamity in Kent" attribution="By permission of the British Library" %}
...
{% include embed/image.html src="wc:Doctor_Syn_1915_Doubleday_cover.png" aspect="0.635" caption="Dr Syn Doubleday Cover, 1915" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/13096035-9b0f-47f3-9eff-1f7a3a52c2be" aspect="0.685" caption="Suddenly at his Residence" attribution="By permission of the British Library" %}
...
{% include embed/image.html src="https://stor.artstor.org/stor/9cf10dc0-83c2-4c23-95de-69cfe86bfde1" aspect="0.684" caption="Mystery in the the Channel" attribution="By permission of the British Library" %}
